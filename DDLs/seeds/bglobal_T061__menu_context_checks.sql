...
VALUES
  ('auth.intento.resultado', '{"es": "Resultado", "en": "Outcome"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Resultado de la operación de intento en autenticación y sesión. Registra si la operación fue exitosa o el tipo específico de fallo para forensia y métricas.', true, 1010),
  ('auth.cumplimiento.nivel_cobertura', '{"es": "Nivel de cobertura", "en": "Coverage Level"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Grado de cobertura de nivel de cobertura en autenticación y sesión. Indica qué porcentaje o conjunto de controles está cubierto por la configuración actual.', true, 1020),
  ('auth.credencial.nivel_aal', '{"es": "Nivel de garantía (AAL)", "en": "Loa Provided"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Nivel de nivel de garantía (aal) en autenticación y sesión. Define la graduación del criterio y determina qué controles de seguridad o políticas aplican a cada nivel.', true, 1030),
  ('auth.credencial.estado', '{"es": "Estado", "en": "Status"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Estado operativo de estado en autenticación y sesión. Governa el ciclo de vida del registro y qué transiciones son permitidas según las reglas de negocio.', true, 1040),
  ('auth.fido2.formato_atestacion', '{"es": "Formato de atestación", "en": "Attestation Fmt"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Formato de formato de atestación en autenticación y sesión. Determina cómo se procesa, valida y almacena el dato según el estándar correspondiente.', true, 1050),
  ('auth.secreto.tipo', '{"es": "Tipo", "en": "Type"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Categoría funcional de tipo en autenticación y sesión. La selección determina las reglas de validación, las políticas aplicables y el comportamiento del motor.', true, 1060),
  ('auth.x509.origen', '{"es": "Origen", "en": "Origin"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Origen de origen en autenticación y sesión. Identifica qué componente o proceso generó el dato, clave para trazabilidad forense y gobernanza.', true, 1070),
  ('auth.cripto.estado', '{"es": "Estado", "en": "Status"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Estado operativo de estado en autenticación y sesión. Governa el ciclo de vida del registro y qué transiciones son permitidas según las reglas de negocio.', true, 1080),
  ('auth.cripto.tipo', '{"es": "Tipo", "en": "Type"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Categoría funcional de tipo en autenticación y sesión. La selección determina las reglas de validación, las políticas aplicables y el comportamiento del motor.', true, 1090),
  ('auth.dispositivo.categoria', '{"es": "Categoría", "en": "Category"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Categoría de categoría en autenticación y sesión. Agrupa elementos similares para aplicar políticas diferenciadas según su naturaleza funcional.', true, 1100),
  ('auth.dispositivo.version_osdp', '{"es": "Versión OSDP (protocolo lector físico)", "en": "Osdp Version"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Versión OSDP (protocolo lector físico) en autenticación y sesión. Controla la columna auth_device.osdp_version y asegura integridad referencial sin FK nativa.', true, 1110),
  ('auth.dispositivo.plataforma', '{"es": "Plataforma", "en": "Platform"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Plataforma en autenticación y sesión. Controla la columna auth_device.platform y asegura integridad referencial sin FK nativa.', true, 1120),
  ('auth.dispositivo.estado', '{"es": "Estado", "en": "Status"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Estado operativo de estado en autenticación y sesión. Governa el ciclo de vida del registro y qué transiciones son permitidas según las reglas de negocio.', true, 1130),
  ('auth.dispositivo.confianza', '{"es": "Nivel de confianza", "en": "Trust Level"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Nivel de confianza en autenticación y sesión. Controla la columna auth_device.trust_level y asegura integridad referencial sin FK nativa.', true, 1140),
  ('auth.vinculo_disp.tipo_vinculo', '{"es": "Tipo de vínculo", "en": "Binding Type"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Tipo de vínculo en autenticación y sesión. Controla la columna auth_device_credential_binding.binding_type y asegura integridad referencial sin FK nativa.', true, 1150),
  ('auth.postura_disp.cumplimiento', '{"es": "Estado de cumplimiento", "en": "Compliance Status"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Estado de cumplimiento en autenticación y sesión. Controla la columna auth_device_posture.compliance_status y asegura integridad referencial sin FK nativa.', true, 1160),
  ('auth.postura_disp.mdm', '{"es": "Cumplimiento MDM", "en": "Mdm Compliance"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Cumplimiento MDM en autenticación y sesión. Controla la columna auth_device_posture.mdm_compliance y asegura integridad referencial sin FK nativa.', true, 1170),
  ('auth.postura_disp.fuente_postura', '{"es": "Fuente de postura", "en": "Posture Source"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Fuente de postura en autenticación y sesión. Controla la columna auth_device_posture.posture_source y asegura integridad referencial sin FK nativa.', true, 1180),
  ('auth.federacion.estado', '{"es": "Estado", "en": "Status"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Estado operativo de estado en autenticación y sesión. Governa el ciclo de vida del registro y qué transiciones son permitidas según las reglas de negocio.', true, 1190),
  ('auth.metodo.categoria', '{"es": "Categoría", "en": "Category"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Categoría de categoría en autenticación y sesión. Agrupa elementos similares para aplicar políticas diferenciadas según su naturaleza funcional.', true, 1200),
  ('auth.metodo.estado', '{"es": "Estado", "en": "Status"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Estado operativo de estado en autenticación y sesión. Governa el ciclo de vida del registro y qué transiciones son permitidas según las reglas de negocio.', true, 1210),
  ('auth.saga.estado', '{"es": "Estado", "en": "Status"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Estado operativo de estado en autenticación y sesión. Governa el ciclo de vida del registro y qué transiciones son permitidas según las reglas de negocio.', true, 1220),
  ('blk.cuenta.estado', '{"es": "Estado", "en": "Status"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Estado operativo de estado en blockchain y trazabilidad. Governa el ciclo de vida del registro y qué transiciones son permitidas según las reglas de negocio.', true, 1230),
  ('blk.ancla.cadena', '{"es": "Cadena", "en": "Chain"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Cadena en blockchain y trazabilidad. Controla la columna blk_anchor.chain y asegura integridad referencial sin FK nativa.', true, 1240),
  ('blk.ancla.estado', '{"es": "Estado", "en": "Status"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Estado operativo de estado en blockchain y trazabilidad. Governa el ciclo de vida del registro y qué transiciones son permitidas según las reglas de negocio.', true, 1250),
  ('blk.merkle.estado', '{"es": "Estado", "en": "Status"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Estado operativo de estado en blockchain y trazabilidad. Governa el ciclo de vida del registro y qué transiciones son permitidas según las reglas de negocio.', true, 1260),
  ('blk.reconciliacion.estado', '{"es": "Estado", "en": "Status"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Estado operativo de estado en blockchain y trazabilidad. Governa el ciclo de vida del registro y qué transiciones son permitidas según las reglas de negocio.', true, 1270),
  ('cfg.politica.factor_auth', '{"es": "Factor de autenticación", "en": "Auth Factor"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Factor de autenticación en configuración del sistema. Controla la columna cfg_policy_library.auth_factor y asegura integridad referencial sin FK nativa.', true, 1280),
  ('cfg.politica.aplicacion', '{"es": "Modo de aplicación", "en": "Enforcement"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Modo de aplicación en configuración del sistema. Controla la columna cfg_policy_library.enforcement y asegura integridad referencial sin FK nativa.', true, 1290),
  ('cfg.politica.ciclo_vida', '{"es": "Ciclo de vida", "en": "Lifecycle"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Ciclo de vida en configuración del sistema. Controla la columna cfg_policy_library.lifecycle y asegura integridad referencial sin FK nativa.', true, 1300),
  ('cfg.politica.tipo_nodo', '{"es": "Tipo de nodo", "en": "Node Type"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Tipo de nodo en configuración del sistema. Controla la columna cfg_policy_library.node_type y asegura integridad referencial sin FK nativa.', true, 1310),
  ('cfg.politica.nivel_riesgo', '{"es": "Nivel de riesgo", "en": "Risk Level"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Nivel de riesgo en configuración del sistema. Controla la columna cfg_policy_library.risk_level y asegura integridad referencial sin FK nativa.', true, 1320),
  ('cfg.politica.tipo_semantico', '{"es": "Tipo semántico", "en": "Semantic Type"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Tipo semántico en configuración del sistema. Controla la columna cfg_policy_library.semantic_type y asegura integridad referencial sin FK nativa.', true, 1330),
  ('fed.cliente.perfil_fapi', '{"es": "Perfil FAPI", "en": "Fapi Profile"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Perfil FAPI en federación e identidad externa. Controla la columna fed_client.fapi_profile y asegura integridad referencial sin FK nativa.', true, 1340),
  ('fed.cliente.estado', '{"es": "Estado", "en": "Status"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Estado operativo de estado en federación e identidad externa. Governa el ciclo de vida del registro y qué transiciones son permitidas según las reglas de negocio.', true, 1350),
  ('fed.cliente.tipo', '{"es": "Tipo", "en": "Type"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Categoría funcional de tipo en federación e identidad externa. La selección determina las reglas de validación, las políticas aplicables y el comportamiento del motor.', true, 1360),
  ('fed.proveedor.nivel_fal', '{"es": "Nivel FAL", "en": "Fal"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Nivel FAL en federación e identidad externa. Controla la columna fed_provider_ext.fal, idn_tenant_fal_config.fal_level y asegura integridad referencial sin FK nativa.', true, 1370),
  ('fed.proveedor.protocolo', '{"es": "Protocolo", "en": "Protocol"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Método o protocolo usado en proveedor de federación e identidad externa. Determina los estándares técnicos aplicables y las políticas de seguridad correspondientes.', true, 1380),
  ('fed.token.tipo', '{"es": "Tipo", "en": "Type"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Categoría funcional de tipo en federación e identidad externa. La selección determina las reglas de validación, las políticas aplicables y el comportamiento del motor.', true, 1390),
  ('acceso.contrato.tipo_acceso', '{"es": "Tipo de acceso", "en": "Access Type"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Tipo de acceso en el dominio acceso. Controla la columna idn_access_contract.access_type y asegura integridad referencial sin FK nativa.', true, 1400),
  ('acceso.contrato.estado', '{"es": "Estado", "en": "Status"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Estado operativo de estado en el dominio acceso. Governa el ciclo de vida del registro y qué transiciones son permitidas según las reglas de negocio.', true, 1410),
  ('registry.attr_schema.clasificacion', '{"es": "Clasificación", "en": "Classification"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Clasificación en el dominio registry. Controla la columna idn_attribute_schema.classification, idn_identity_attribute.classification y asegura integridad referencial sin FK nativa.', true, 1420),
  ('registry.attr_schema.mutabilidad', '{"es": "Mutabilidad", "en": "Mutability"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Mutabilidad en el dominio registry. Controla la columna idn_attribute_schema.mutability y asegura integridad referencial sin FK nativa.', true, 1430),
  ('registry.attr_schema.campo_retorno', '{"es": "Campo retornado", "en": "Returned"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Campo retornado en el dominio registry. Controla la columna idn_attribute_schema.returned, idn_identity_attribute.returned y asegura integridad referencial sin FK nativa.', true, 1440),
  ('registry.attr_schema.tipo_dato', '{"es": "Tipo de dato", "en": "Data Type"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Tipo de dato en el dominio registry. Controla la columna idn_attribute_schema.data_type y asegura integridad referencial sin FK nativa.', true, 1450),
  ('d11.auditoria.codigo_dominio', '{"es": "Código de dominio", "en": "Domain Code"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Código de dominio en el dominio d11. Controla la columna idn_audit_event_log.domain_code, idn_audit_event_log_2026_07.domain_code y asegura integridad referencial sin FK nativa.', true, 1460),
  ('d11.auditoria.resultado', '{"es": "Resultado", "en": "Outcome"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Resultado de la operación de auditoria en el dominio d11. Registra si la operación fue exitosa o el tipo específico de fallo para forensia y métricas.', true, 1470),
  ('d11.auditoria.tipo_sujeto', '{"es": "Tipo de sujeto", "en": "Subject Type"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Tipo de sujeto en el dominio d11. Controla la columna idn_audit_event_log.subject_type, idn_audit_event_log_2026_07.subject_type y asegura integridad referencial sin FK nativa.', true, 1480),
  ('d11.retencion.accion_expiracion', '{"es": "Acción al expirar", "en": "Expiration Action"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Acción al expirar en el dominio d11. Controla la columna idn_audit_retention_policy.expiration_action y asegura integridad referencial sin FK nativa.', true, 1490),
  ('d11.siem.formato_log', '{"es": "Formato de log", "en": "Log Format"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Formato de formato de log en el dominio d11. Determina cómo se procesa, valida y almacena el dato según el estándar correspondiente.', true, 1500),
  ('d11.siem.tipo_protocolo', '{"es": "Tipo de protocolo", "en": "Protocol Type"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Proveedor o protocolo de tipo de protocolo en el dominio d11. Define el integrador externo y los estándares de interoperabilidad que debe cumplir.', true, 1510),
  ('d05.inscripcion.tipo_biometrico', '{"es": "Tipo biométrico", "en": "Biometric Type"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Tipo biométrico en el dominio d05. Controla la columna idn_biometric_enrollment.biometric_type, idn_biometric_pad_policy.biometric_type y asegura integridad referencial sin FK nativa.', true, 1520),
  ('d05.inscripcion.estado', '{"es": "Estado", "en": "Status"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Estado operativo de estado en el dominio d05. Governa el ciclo de vida del registro y qué transiciones son permitidas según las reglas de negocio.', true, 1530),
  ('d05.identificacion.resultado', '{"es": "Resultado", "en": "Result"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Resultado de la operación de identificacion en el dominio d05. Registra si la operación fue exitosa o el tipo específico de fallo para forensia y métricas.', true, 1540),
  ('d05.pad.accion_fallo', '{"es": "Acción en fallo", "en": "Fail Action"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Acción en fallo en el dominio d05. Controla la columna idn_biometric_pad_policy.fail_action y asegura integridad referencial sin FK nativa.', true, 1550),
  ('d05.pad.nivel_pad', '{"es": "Nivel PAD (anti-spoofing)", "en": "Pad Level"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Nivel PAD (anti-spoofing) en el dominio d05. Controla la columna idn_biometric_pad_policy.pad_level y asegura integridad referencial sin FK nativa.', true, 1560),
  ('d05.pad.estado', '{"es": "Estado", "en": "Status"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Estado operativo de estado en el dominio d05. Governa el ciclo de vida del registro y qué transiciones son permitidas según las reglas de negocio.', true, 1570),
  ('d05.revocacion_bio.motivo_revocacion', '{"es": "Motivo de revocación", "en": "Revocation Reason"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Motivo de revocación en el dominio d05. Controla la columna idn_biometric_revocation.revocation_reason y asegura integridad referencial sin FK nativa.', true, 1580),
  ('d05.verificacion_bio.resultado', '{"es": "Resultado", "en": "Outcome"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Resultado de la operación de verificacion bio en el dominio d05. Registra si la operación fue exitosa o el tipo específico de fallo para forensia y métricas.', true, 1590),
  ('d12.ancla.tipo_evento_fuente', '{"es": "Tipo de evento fuente", "en": "Source Event Type"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Tipo de evento fuente en el dominio d12. Controla la columna idn_blockchain_anchor_ext.source_event_type y asegura integridad referencial sin FK nativa.', true, 1600),
  ('d12.nodo.estado', '{"es": "Estado", "en": "Status"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Estado operativo de estado en el dominio d12. Governa el ciclo de vida del registro y qué transiciones son permitidas según las reglas de negocio.', true, 1610),
  ('d12.transaccion.estado', '{"es": "Estado", "en": "Status"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Estado operativo de estado en el dominio d12. Governa el ciclo de vida del registro y qué transiciones son permitidas según las reglas de negocio.', true, 1620),
  ('d12.transaccion.tipo_tx', '{"es": "Tipo de transacción blockchain", "en": "Tx Type"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Tipo de transacción blockchain en el dominio d12. Controla la columna idn_blockchain_transaction.tx_type y asegura integridad referencial sin FK nativa.', true, 1630),
  ('d12.wallet.cadena', '{"es": "Cadena", "en": "Chain"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Cadena en el dominio d12. Controla la columna idn_blockchain_wallet.chain y asegura integridad referencial sin FK nativa.', true, 1640),
  ('d12.wallet.estado', '{"es": "Estado", "en": "Status"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Estado operativo de estado en el dominio d12. Governa el ciclo de vida del registro y qué transiciones son permitidas según las reglas de negocio.', true, 1650),
  ('d09.revocacion_cred.motivo', '{"es": "Motivo", "en": "Motivo"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Motivo en el dominio d09. Controla la columna idn_credencial_revocacion.motivo y asegura integridad referencial sin FK nativa.', true, 1660),
  ('d09.token.motivo_revocacion', '{"es": "Motivo de revocación", "en": "Revocation Reason"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Motivo de revocación en el dominio d09. Controla la columna idn_credential_token_issued.revocation_reason, idn_credential_token_issued_2026_07.revocation_reason y asegura integridad referencial sin FK nativa.', true, 1670),
  ('d09.token.tipo_token', '{"es": "Tipo de token", "en": "Token Type"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Tipo de token en el dominio d09. Controla la columna idn_credential_token_issued.token_type, idn_credential_token_issued_2026_07.token_type y asegura integridad referencial sin FK nativa.', true, 1680),
  ('d10.delegacion.tipo_delegacion', '{"es": "Tipo de delegación", "en": "Delegation Type"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Tipo de delegación en el dominio d10. Controla la columna idn_delegation_grant.delegation_type y asegura integridad referencial sin FK nativa.', true, 1690),
  ('d10.rar.estado', '{"es": "Estado", "en": "Status"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Estado operativo de estado en el dominio d10. Governa el ciclo de vida del registro y qué transiciones son permitidas según las reglas de negocio.', true, 1700),
  ('d10.restriccion.tipo_restriccion', '{"es": "Tipo de restricción", "en": "Restriction Type"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Tipo de restricción en el dominio d10. Controla la columna idn_delegation_restriction.restriction_type y asegura integridad referencial sin FK nativa.', true, 1710),
  ('d10.uso_delegacion.resultado', '{"es": "Resultado", "en": "Outcome"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Resultado de la operación de uso delegacion en el dominio d10. Registra si la operación fue exitosa o el tipo específico de fallo para forensia y métricas.', true, 1720),
  ('identidad.did.estado', '{"es": "Estado", "en": "Status"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Estado operativo de estado en el dominio identidad. Governa el ciclo de vida del registro y qué transiciones son permitidas según las reglas de negocio.', true, 1730),
  ('privacidad.dpia_reg.estado', '{"es": "Estado", "en": "Estado"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Estado operativo de estado en el dominio privacidad. Governa el ciclo de vida del registro y qué transiciones son permitidas según las reglas de negocio.', true, 1740),
  ('privacidad.dpia_reg.riesgo_residual', '{"es": "Riesgo residual (DPIA)", "en": "Riesgo Residual"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Riesgo residual (DPIA) en el dominio privacidad. Controla la columna idn_dpia_registro.riesgo_residual y asegura integridad referencial sin FK nativa.', true, 1750),
  ('d03.aprobacion.tipo_operacion', '{"es": "Tipo de operación", "en": "Operation Type"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Tipo de operación en el dominio d03. Controla la columna idn_financial_approval.operation_type y asegura integridad referencial sin FK nativa.', true, 1760),
  ('d03.voto.decision', '{"es": "Decisión", "en": "Decision"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Decisión o acción en el flujo de voto del dominio el dominio d03. Define el desenlace del proceso y las acciones de seguimiento que se activan.', true, 1770),
  ('d03.fraude.tipo_alerta', '{"es": "Tipo de alerta de fraude", "en": "Alert Type"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Tipo de alerta de fraude en el dominio d03. Controla la columna idn_financial_fraud_alert.alert_type y asegura integridad referencial sin FK nativa.', true, 1780),
  ('d03.fraude.resultado', '{"es": "Resultado", "en": "Result"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Resultado de la operación de fraude en el dominio d03. Registra si la operación fue exitosa o el tipo específico de fallo para forensia y métricas.', true, 1790),
  ('d03.factura.estado_sin', '{"es": "Estado SIN Bolivia", "en": "Sin Status"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Estado SIN Bolivia en el dominio d03. Controla la columna idn_financial_invoice_auth.sin_status y asegura integridad referencial sin FK nativa.', true, 1800),
  ('d03.limite.tipo_operacion', '{"es": "Tipo de operación", "en": "Operation Type"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Tipo de operación en el dominio d03. Controla la columna idn_financial_limit.operation_type y asegura integridad referencial sin FK nativa.', true, 1810),
  ('d03.limite.alcance', '{"es": "Alcance", "en": "Scope"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Alcance de alcance en el dominio d03. Define el rango de aplicación de la configuración y qué componentes del sistema aplican el valor.', true, 1820),
  ('d03.limite.estado', '{"es": "Estado", "en": "Status"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Estado operativo de estado en el dominio d03. Governa el ciclo de vida del registro y qué transiciones son permitidas según las reglas de negocio.', true, 1830),
  ('d03.reconciliacion.tipo_reconciliacion', '{"es": "Tipo de reconciliación", "en": "Reconciliation Type"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Tipo de reconciliación en el dominio d03. Controla la columna idn_financial_reconciliation.reconciliation_type y asegura integridad referencial sin FK nativa.', true, 1840),
  ('d03.reconciliacion.estado', '{"es": "Estado", "en": "Status"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Estado operativo de estado en el dominio d03. Governa el ciclo de vida del registro y qué transiciones son permitidas según las reglas de negocio.', true, 1850),
  ('d03.reporte.tipo_reporte', '{"es": "Tipo de reporte", "en": "Report Type"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Tipo de reporte en el dominio d03. Controla la columna idn_financial_report.report_type y asegura integridad referencial sin FK nativa.', true, 1860),
  ('d03.reporte.estado', '{"es": "Estado", "en": "Status"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Estado operativo de estado en el dominio d03. Governa el ciclo de vida del registro y qué transiciones son permitidas según las reglas de negocio.', true, 1870),
  ('d03.sod.tipo_conflicto', '{"es": "Tipo de conflicto", "en": "Conflict Type"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Tipo de conflicto en el dominio d03. Controla la columna idn_financial_sod_rule.conflict_type y asegura integridad referencial sin FK nativa.', true, 1880),
  ('d03.tpp.perfil_fapi', '{"es": "Perfil FAPI", "en": "Fapi Profile"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Perfil FAPI en el dominio d03. Controla la columna idn_financial_tpp_consent.fapi_profile y asegura integridad referencial sin FK nativa.', true, 1890),
  ('d03.tpp.revocado_por', '{"es": "Revocado por", "en": "Revoked By"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Revocado por en el dominio d03. Controla la columna idn_financial_tpp_consent.revoked_by y asegura integridad referencial sin FK nativa.', true, 1900),
  ('d06.residencia.aplica_a', '{"es": "Aplica a", "en": "Apply To"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Aplica a en el dominio d06. Controla la columna idn_geospatial_data_residency.apply_to y asegura integridad referencial sin FK nativa.', true, 1910),
  ('d06.residencia.accion_violacion', '{"es": "Acción en violación", "en": "Violation Action"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Acción en violación en el dominio d06. Controla la columna idn_geospatial_data_residency.violation_action y asegura integridad referencial sin FK nativa.', true, 1920),
  ('d06.geocerca.accion_dentro', '{"es": "Acción dentro de geocerca", "en": "Action Inside"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Acción dentro de geocerca en el dominio d06. Controla la columna idn_geospatial_geofence.action_inside y asegura integridad referencial sin FK nativa.', true, 1930),
  ('d06.geocerca.accion_fuera', '{"es": "Acción fuera de geocerca", "en": "Action Outside"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Acción fuera de geocerca en el dominio d06. Controla la columna idn_geospatial_geofence.action_outside, idn_geospatial_velocity_policy.action y asegura integridad referencial sin FK nativa.', true, 1940),
  ('d06.geocerca.tipo_geocerca', '{"es": "Tipo de geocerca", "en": "Fence Type"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Tipo de geocerca en el dominio d06. Controla la columna idn_geospatial_geofence.fence_type y asegura integridad referencial sin FK nativa.', true, 1950),
  ('d06.ubicacion.fuente_ubicacion', '{"es": "Fuente de ubicación", "en": "Location Source"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Fuente de ubicación en el dominio d06. Controla la columna idn_geospatial_location_log.location_source, idn_geospatial_location_log_2026_07.location_source y asegura integridad referencial sin FK nativa.', true, 1960),
  ('d99.admin.rol_admin', '{"es": "Rol de administrador global", "en": "Admin Role"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Rol de administrador global en el dominio d99. Controla la columna idn_global_admin.admin_role y asegura integridad referencial sin FK nativa.', true, 1970),
  ('d99.cumplimiento.estado', '{"es": "Estado", "en": "Status"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Estado operativo de estado en el dominio d99. Governa el ciclo de vida del registro y qué transiciones son permitidas según las reglas de negocio.', true, 1980),
  ('d99.cripto.familia_algoritmo', '{"es": "Familia de algoritmo", "en": "Algorithm Family"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Familia de algoritmo en el dominio d99. Controla la columna idn_global_crypto_params.algorithm_family y asegura integridad referencial sin FK nativa.', true, 1990),
  ('d99.hitl.tipo_entidad', '{"es": "Tipo de entidad afectada", "en": "Affected Entity Type"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Tipo de entidad afectada en el dominio d99. Controla la columna idn_global_hitl_exception.affected_entity_type y asegura integridad referencial sin FK nativa.', true, 2000),
  ('d99.hitl.tipo_excepcion', '{"es": "Tipo de excepción", "en": "Exception Type"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Tipo de excepción en el dominio d99. Controla la columna idn_global_hitl_exception.exception_type y asegura integridad referencial sin FK nativa.', true, 2010),
  ('d99.hitl.estado', '{"es": "Estado", "en": "Status"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Estado operativo de estado en el dominio d99. Governa el ciclo de vida del registro y qué transiciones son permitidas según las reglas de negocio.', true, 2020),
  ('d99.notificacion.tipo_notificacion', '{"es": "Tipo de notificación", "en": "Notification Type"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Tipo de notificación en el dominio d99. Controla la columna idn_global_notification.notification_type y asegura integridad referencial sin FK nativa.', true, 2030),
  ('d99.notificacion.severidad', '{"es": "Severidad", "en": "Severity"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Severidad en el dominio d99. Controla la columna idn_global_notification.severity y asegura integridad referencial sin FK nativa.', true, 2040),
  ('d99.notificacion.alcance_destino', '{"es": "Alcance del destino", "en": "Target Scope"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Alcance de alcance del destino en el dominio d99. Define el rango de aplicación de la configuración y qué componentes del sistema aplican el valor.', true, 2050),
  ('d99.sbom.tipo_componente', '{"es": "Tipo de componente SBOM", "en": "Component Type"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Tipo de componente SBOM en el dominio d99. Controla la columna idn_global_sbom.component_type y asegura integridad referencial sin FK nativa.', true, 2060),
  ('d99.sbom.nivel_riesgo', '{"es": "Nivel de riesgo", "en": "Risk Level"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Nivel de riesgo en el dominio d99. Controla la columna idn_global_sbom.risk_level y asegura integridad referencial sin FK nativa.', true, 2070),
  ('identidad.ciclo_vida.tipo_evento', '{"es": "Tipo de evento", "en": "Event Type"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Tipo de evento en el dominio identidad. Controla la columna idn_identidad_lifecycle_event.event_type y asegura integridad referencial sin FK nativa.', true, 2080),
  ('identidad.atributo.mutabilidad', '{"es": "Mutabilidad", "en": "Mutability"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Mutabilidad en el dominio identidad. Controla la columna idn_identity_attribute.mutability y asegura integridad referencial sin FK nativa.', true, 2090),
  ('identidad.atributo.unicidad', '{"es": "Unicidad del atributo", "en": "Uniqueness"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Unicidad del atributo en el dominio identidad. Controla la columna idn_identity_attribute.uniqueness y asegura integridad referencial sin FK nativa.', true, 2100),
  ('identidad.attr_historial.operacion', '{"es": "Operación", "en": "Operation"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Operación en el dominio identidad. Controla la columna idn_identity_attribute_history.operation, idn_identity_attribute_history_2026_07.operation y asegura integridad referencial sin FK nativa.', true, 2110),
  ('identidad.consentimiento.via_otorgamiento', '{"es": "Otorgado vía", "en": "Granted Via"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Otorgado vía en el dominio identidad. Controla la columna idn_identity_consent.granted_via y asegura integridad referencial sin FK nativa.', true, 2120),
  ('identidad.consentimiento.base_legal', '{"es": "Base legal (GDPR)", "en": "Legal Basis"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Base legal (GDPR) en el dominio identidad. Controla la columna idn_identity_consent.legal_basis y asegura integridad referencial sin FK nativa.', true, 2130),
  ('identidad.consentimiento.via_retiro', '{"es": "Retirado vía", "en": "Withdrawn Via"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Retirado vía en el dominio identidad. Controla la columna idn_identity_consent.withdrawn_via y asegura integridad referencial sin FK nativa.', true, 2140),
  ('identidad.entidad.estado', '{"es": "Estado", "en": "Status"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Estado operativo de estado en el dominio identidad. Governa el ciclo de vida del registro y qué transiciones son permitidas según las reglas de negocio.', true, 2150),
  ('identidad.proofing.nivel_eidas', '{"es": "Nivel eIDAS", "en": "Eidas Level"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Nivel eIDAS en el dominio identidad. Controla la columna idn_identity_proofing.eidas_level, idn_identity_vc.eidas_assurance_level y asegura integridad referencial sin FK nativa.', true, 2160),
  ('identidad.proofing.estado', '{"es": "Estado", "en": "Status"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Estado operativo de estado en el dominio identidad. Governa el ciclo de vida del registro y qué transiciones son permitidas según las reglas de negocio.', true, 2170),
  ('identidad.proofing.tipo_proofing', '{"es": "Tipo de proofing", "en": "Proofing Type"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Tipo de proofing en el dominio identidad. Controla la columna idn_identity_proofing.proofing_type y asegura integridad referencial sin FK nativa.', true, 2180),
  ('identidad.vc.tipo_vc_eidas', '{"es": "Tipo VC eIDAS", "en": "Eidas Vc Type"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Tipo VC eIDAS en el dominio identidad. Controla la columna idn_identity_vc.eidas_vc_type y asegura integridad referencial sin FK nativa.', true, 2190),
  ('identidad.vc.formato_vc', '{"es": "Formato VC", "en": "Vc Format"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Formato de formato vc en el dominio identidad. Determina cómo se procesa, valida y almacena el dato según el estándar correspondiente.', true, 2200),
  ('d07.conexion.version_tls', '{"es": "Versión mínima TLS", "en": "Min Tls Version"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Versión mínima TLS en el dominio d07. Controla la columna idn_network_connection_policy.min_tls_version y asegura integridad referencial sin FK nativa.', true, 2210),
  ('d07.propagacion.formato_propagacion', '{"es": "Formato de propagación", "en": "Propagation Format"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Formato de formato de propagación en el dominio d07. Determina cómo se procesa, valida y almacena el dato según el estándar correspondiente.', true, 2220),
  ('d07.dlp.accion_deteccion', '{"es": "Acción al detectar", "en": "Action On Match"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Acción al detectar en el dominio d07. Controla la columna idn_network_dlp_policy.action_on_match y asegura integridad referencial sin FK nativa.', true, 2230),
  ('d07.dpop.algoritmo', '{"es": "Algoritmo criptográfico", "en": "Alg"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Algoritmo criptográfico en el dominio d07. Controla la columna idn_network_dpop_binding.alg y asegura integridad referencial sin FK nativa.', true, 2240),
  ('d07.postura_red.accion_fallo', '{"es": "Acción en fallo", "en": "Action On Fail"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Acción en fallo en el dominio d07. Controla la columna idn_network_posture_policy.action_on_fail y asegura integridad referencial sin FK nativa.', true, 2250),
  ('d07.tasa_limite.accion_exceso', '{"es": "Acción al exceder", "en": "Action On Exceed"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Acción al exceder en el dominio d07. Controla la columna idn_network_rate_policy.action_on_exceed y asegura integridad referencial sin FK nativa.', true, 2260),
  ('d07.tasa_limite.alcance', '{"es": "Alcance", "en": "Scope"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Alcance de alcance en el dominio d07. Define el rango de aplicación de la configuración y qué componentes del sistema aplican el valor.', true, 2270),
  ('d07.segmento.tipo_segmento', '{"es": "Tipo de segmento", "en": "Segment Type"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Tipo de segmento en el dominio d07. Controla la columna idn_network_segment.segment_type y asegura integridad referencial sin FK nativa.', true, 2280),
  ('d07.segmento.confianza', '{"es": "Nivel de confianza", "en": "Trust Level"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Nivel de confianza en el dominio d07. Controla la columna idn_network_segment.trust_level y asegura integridad referencial sin FK nativa.', true, 2290),
  ('d15.nhi_rotacion.accion_fallo', '{"es": "Acción en fallo", "en": "Fail Action"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Acción en fallo en el dominio d15. Controla la columna idn_nhi_rotation_policy.fail_action y asegura integridad referencial sin FK nativa.', true, 2300),
  ('d15.nhi_rotacion.tipo_nhi', '{"es": "Tipo NHI", "en": "Nhi Type"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Tipo NHI en el dominio d15. Controla la columna idn_nhi_rotation_policy.nhi_type y asegura integridad referencial sin FK nativa.', true, 2310),
  ('d15.svid.estado', '{"es": "Estado", "en": "Status"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Estado operativo de estado en el dominio d15. Governa el ciclo de vida del registro y qué transiciones son permitidas según las reglas de negocio.', true, 2320),
  ('d15.svid.tipo_svid', '{"es": "Tipo de SVID", "en": "Svid Type"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Tipo de SVID en el dominio d15. Controla la columna idn_nhi_svid.svid_type y asegura integridad referencial sin FK nativa.', true, 2330),
  ('d02.credencial_fisica.tipo_credencial', '{"es": "Tipo de credencial", "en": "Credential Type"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Tipo de credencial en el dominio d02. Controla la columna idn_physical_access_credential.credential_type y asegura integridad referencial sin FK nativa.', true, 2340),
  ('d02.emergencia.modo_puerta', '{"es": "Modo de puerta de emergencia", "en": "Door Mode"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Modo de puerta de emergencia en el dominio d02. Controla la columna idn_physical_access_emergency.door_mode y asegura integridad referencial sin FK nativa.', true, 2350),
  ('d02.emergencia.tipo_emergencia', '{"es": "Tipo de emergencia física", "en": "Emergency Type"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Tipo de emergencia física en el dominio d02. Controla la columna idn_physical_access_emergency.emergency_type y asegura integridad referencial sin FK nativa.', true, 2360),
  ('d02.evento_fisico.tipo_credencial', '{"es": "Tipo de credencial", "en": "Credential Type"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Tipo de credencial en el dominio d02. Controla la columna idn_physical_access_event_log.credential_type, idn_physical_access_event_log_2026_07.credential_type y asegura integridad referencial sin FK nativa.', true, 2370),
  ('d02.evento_fisico.tipo_evento', '{"es": "Tipo de evento", "en": "Event Type"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Tipo de evento en el dominio d02. Controla la columna idn_physical_access_event_log.event_type, idn_physical_access_event_log_2026_07.event_type y asegura integridad referencial sin FK nativa.', true, 2380),
  ('d02.evento_fisico.resultado', '{"es": "Resultado", "en": "Outcome"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Resultado de la operación de evento fisico en el dominio d02. Registra si la operación fue exitosa o el tipo específico de fallo para forensia y métricas.', true, 2390),
  ('d02.ubicacion_fisica.tipo_ubicacion', '{"es": "Tipo de ubicación", "en": "Location Type"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Tipo de ubicación en el dominio d02. Controla la columna idn_physical_access_location.location_type y asegura integridad referencial sin FK nativa.', true, 2400),
  ('d02.ubicacion_fisica.estado', '{"es": "Estado", "en": "Status"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Estado operativo de estado en el dominio d02. Governa el ciclo de vida del registro y qué transiciones son permitidas según las reglas de negocio.', true, 2410),
  ('d02.lector.direccion', '{"es": "Dirección", "en": "Direction"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Dirección en el dominio d02. Controla la columna idn_physical_access_reader.direction y asegura integridad referencial sin FK nativa.', true, 2420),
  ('d02.lector.protocolo', '{"es": "Protocolo", "en": "Protocol"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Método o protocolo usado en lector de el dominio d02. Determina los estándares técnicos aplicables y las políticas de seguridad correspondientes.', true, 2430),
  ('d02.lector.tipo_lector', '{"es": "Tipo de lector", "en": "Reader Type"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Tipo de lector en el dominio d02. Controla la columna idn_physical_access_reader.reader_type y asegura integridad referencial sin FK nativa.', true, 2440),
  ('d02.lector.estado', '{"es": "Estado", "en": "Status"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Estado operativo de estado en el dominio d02. Governa el ciclo de vida del registro y qué transiciones son permitidas según las reglas de negocio.', true, 2450),
  ('d02.visita.estado', '{"es": "Estado", "en": "Status"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Estado operativo de estado en el dominio d02. Governa el ciclo de vida del registro y qué transiciones son permitidas según las reglas de negocio.', true, 2460),
  ('cfg.nodo_politica.tamano_fuente', '{"es": "Token de tamaño de fuente", "en": "Font Size Token"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Token de tamaño de fuente en configuración del sistema. Controla la columna idn_policy_node_type.font_size_token y asegura integridad referencial sin FK nativa.', true, 2470),
  ('registry.schema_attr.categoria', '{"es": "Categoría", "en": "Category"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Categoría de categoría en el dominio registry. Agrupa elementos similares para aplicar políticas diferenciadas según su naturaleza funcional.', true, 2480),
  ('registry.schema_attr.clasificacion', '{"es": "Clasificación", "en": "Classification"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Clasificación en el dominio registry. Controla la columna idn_registry_attribute_schema.classification y asegura integridad referencial sin FK nativa.', true, 2490),
  ('registry.schema_attr.tipo_dato', '{"es": "Tipo de dato", "en": "Data Type"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Tipo de dato en el dominio registry. Controla la columna idn_registry_attribute_schema.data_type y asegura integridad referencial sin FK nativa.', true, 2500),
  ('registry.schema_attr.mutabilidad', '{"es": "Mutabilidad", "en": "Mutability"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Mutabilidad en el dominio registry. Controla la columna idn_registry_attribute_schema.mutability y asegura integridad referencial sin FK nativa.', true, 2510),
  ('registry.schema_attr.fuente', '{"es": "Fuente", "en": "Source"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Fuente en el dominio registry. Controla la columna idn_registry_attribute_schema.source y asegura integridad referencial sin FK nativa.', true, 2520),
  ('d15.nhi_agente.tipo_sesion', '{"es": "Tipo de sesión", "en": "Session Type"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Tipo de sesión en el dominio d15. Controla la columna idn_roles_nhi_agent_identity.session_type y asegura integridad referencial sin FK nativa.', true, 2530),
  ('d15.nhi_cert.decision', '{"es": "Decisión", "en": "Decision"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Decisión o acción en el flujo de nhi cert del dominio el dominio d15. Define el desenlace del proceso y las acciones de seguimiento que se activan.', true, 2540),
  ('d15.nhi_identidad.estado', '{"es": "Estado", "en": "Status"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Estado operativo de estado en el dominio d15. Governa el ciclo de vida del registro y qué transiciones son permitidas según las reglas de negocio.', true, 2550),
  ('d15.nhi_identidad.tipo_nhi', '{"es": "Tipo NHI", "en": "Nhi Type"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Tipo NHI en el dominio d15. Controla la columna idn_roles_nhi_identity.nhi_type y asegura integridad referencial sin FK nativa.', true, 2560),
  ('d15.nhi_ciclo.tipo_evento', '{"es": "Tipo de evento", "en": "Event Type"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Tipo de evento en el dominio d15. Controla la columna idn_roles_nhi_lifecycle_event.event_type y asegura integridad referencial sin FK nativa.', true, 2570),
  ('rol.ciclo_vida.tipo_disparador', '{"es": "Tipo de disparador del ciclo de vida", "en": "Trigger Type"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Tipo de disparador del ciclo de vida en el dominio rol. Controla la columna idn_roles_rol_lifecycle_event.trigger_type y asegura integridad referencial sin FK nativa.', true, 2580),
  ('rol.template.operacion', '{"es": "Operación", "en": "Operation"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Operación en el dominio rol. Controla la columna idn_roles_template_history.operation y asegura integridad referencial sin FK nativa.', true, 2590),
  ('rol.ver_retencion.clase_info', '{"es": "Clase de información", "en": "Info Class"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Clase de información en el dominio rol. Controla la columna idn_roles_ver_b01_retention_policy.info_class y asegura integridad referencial sin FK nativa.', true, 2600),
  ('rol.ver_contrato.compatibilidad', '{"es": "Compatibilidad", "en": "Compatibility"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Compatibilidad en el dominio rol. Controla la columna idn_roles_ver_contract_revision_log.compatibility y asegura integridad referencial sin FK nativa.', true, 2610),
  ('scim.mapeo_attr.mutabilidad_scim', '{"es": "Mutabilidad SCIM", "en": "Scim Mutability"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Mutabilidad SCIM en el dominio scim. Controla la columna idn_scim_attribute_map.scim_mutability y asegura integridad referencial sin FK nativa.', true, 2620),
  ('scim.mapeo_attr.recurso_scim', '{"es": "Recurso SCIM", "en": "Scim Resource"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Recurso SCIM en el dominio scim. Controla la columna idn_scim_attribute_map.scim_resource y asegura integridad referencial sin FK nativa.', true, 2630),
  ('scim.mapeo_attr.retorno_scim', '{"es": "Retorno SCIM", "en": "Scim Returned"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Retorno SCIM en el dominio scim. Controla la columna idn_scim_attribute_map.scim_returned y asegura integridad referencial sin FK nativa.', true, 2640),
  ('scim.mapeo_attr.tabla_local', '{"es": "Tabla local", "en": "Local Table"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Tabla local en el dominio scim. Controla la columna idn_scim_attribute_map.local_table y asegura integridad referencial sin FK nativa.', true, 2650),
  ('d13.cadena_ca.tipo_ca', '{"es": "Tipo de CA", "en": "Ca Type"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Tipo de CA en el dominio d13. Controla la columna idn_signature_ca_chain.ca_type y asegura integridad referencial sin FK nativa.', true, 2660),
  ('d13.eudi_wallet.estado', '{"es": "Estado", "en": "Status"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Estado operativo de estado en el dominio d13. Governa el ciclo de vida del registro y qué transiciones son permitidas según las reglas de negocio.', true, 2670),
  ('d13.solicitud_firma.tipo_documento', '{"es": "Tipo de documento", "en": "Document Type"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Tipo de documento en el dominio d13. Controla la columna idn_signature_request.document_type y asegura integridad referencial sin FK nativa.', true, 2680),
  ('d13.solicitud_firma.motor', '{"es": "Motor", "en": "Engine"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Motor en el dominio d13. Controla la columna idn_signature_request.engine y asegura integridad referencial sin FK nativa.', true, 2690),
  ('d13.solicitud_firma.formato_firma', '{"es": "Formato de firma", "en": "Signature Format"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Formato de formato de firma en el dominio d13. Determina cómo se procesa, valida y almacena el dato según el estándar correspondiente.', true, 2700),
  ('d13.solicitud_firma.estado', '{"es": "Estado", "en": "Status"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Estado operativo de estado en el dominio d13. Governa el ciclo de vida del registro y qué transiciones son permitidas según las reglas de negocio.', true, 2710),
  ('d13.revocacion_cert.fuente_verificacion', '{"es": "Fuente de verificación CRL/OCSP", "en": "Check Source"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Fuente de verificación CRL/OCSP en el dominio d13. Controla la columna idn_signature_revocation_cache.check_source y asegura integridad referencial sin FK nativa.', true, 2720),
  ('d13.revocacion_cert.estado', '{"es": "Estado", "en": "Status"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Estado operativo de estado en el dominio d13. Governa el ciclo de vida del registro y qué transiciones son permitidas según las reglas de negocio.', true, 2730),
  ('d13.verificacion_firma.estado_cert', '{"es": "Estado del certificado", "en": "Cert Status"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Estado del certificado en el dominio d13. Controla la columna idn_signature_verification_log.cert_status y asegura integridad referencial sin FK nativa.', true, 2740),
  ('d13.verificacion_firma.resultado', '{"es": "Resultado", "en": "Outcome"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Resultado de la operación de verificacion firma en el dominio d13. Registra si la operación fue exitosa o el tipo específico de fallo para forensia y métricas.', true, 2750),
  ('d04.excepcion_temp.tipo_excepcion', '{"es": "Tipo de excepción", "en": "Exception Type"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Tipo de excepción en el dominio d04. Controla la columna idn_temporal_exception.exception_type y asegura integridad referencial sin FK nativa.', true, 2760),
  ('d04.turno.tipo_rotacion', '{"es": "Tipo de rotación", "en": "Rotation Type"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Tipo de rotación en el dominio d04. Controla la columna idn_temporal_shift.rotation_type y asegura integridad referencial sin FK nativa.', true, 2770),
  ('d04.ventana_temporal.tipo_ventana', '{"es": "Tipo de ventana temporal", "en": "Window Type"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Tipo de ventana temporal en el dominio d04. Controla la columna idn_temporal_window.window_type y asegura integridad referencial sin FK nativa.', true, 2780),
  ('identidad.usuario.metodo_registro', '{"es": "Método de registro", "en": "Registration Method"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Método de registro en el dominio identidad. Controla la columna idn_user.registration_method y asegura integridad referencial sin FK nativa.', true, 2790),
  ('identidad.usuario.estado', '{"es": "Estado", "en": "Status"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Estado operativo de estado en el dominio identidad. Governa el ciclo de vida del registro y qué transiciones son permitidas según las reglas de negocio.', true, 2800),
  ('identidad.recuperacion.estado', '{"es": "Estado", "en": "Status"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Estado operativo de estado en el dominio identidad. Governa el ciclo de vida del registro y qué transiciones son permitidas según las reglas de negocio.', true, 2810),
  ('identidad.recuperacion.tipo', '{"es": "Tipo", "en": "Type"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Categoría funcional de tipo en el dominio identidad. La selección determina las reglas de validación, las políticas aplicables y el comportamiento del motor.', true, 2820),
  ('d14.breakglass.metodo_auth', '{"es": "Método de autenticación privilegiada", "en": "Auth Method"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Método de autenticación privilegiada en el dominio d14. Controla la columna pam_breakglass_activation.auth_method y asegura integridad referencial sin FK nativa.', true, 2830),
  ('d14.breakglass.estado', '{"es": "Estado", "en": "Status"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Estado operativo de estado en el dominio d14. Governa el ciclo de vida del registro y qué transiciones son permitidas según las reglas de negocio.', true, 2840),
  ('d14.breakglass.estado._control', '{"es": "Estado", "en": "Status"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Estado operativo de estado en el dominio d14. Governa el ciclo de vida del registro y qué transiciones son permitidas según las reglas de negocio.', true, 2850),
  ('d14.credencial_priv.politica_rotacion', '{"es": "Política de rotación", "en": "Rotation Policy"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Política de rotación en el dominio d14. Controla la columna pam_credential_ref.rotation_policy y asegura integridad referencial sin FK nativa.', true, 2860),
  ('d14.credencial_priv.estado', '{"es": "Estado", "en": "Status"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Estado operativo de estado en el dominio d14. Governa el ciclo de vida del registro y qué transiciones son permitidas según las reglas de negocio.', true, 2870),
  ('d14.credencial_priv.tipo_credencial', '{"es": "Tipo de credencial", "en": "Credential Type"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Tipo de credencial en el dominio d14. Controla la columna pam_credential_ref.credential_type, pam_nhi_secret_ref.secret_type y asegura integridad referencial sin FK nativa.', true, 2880),
  ('d14.cuenta_priv.estado', '{"es": "Estado", "en": "Estado"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Estado operativo de estado en el dominio d14. Governa el ciclo de vida del registro y qué transiciones son permitidas según las reglas de negocio.', true, 2890),
  ('d14.cuenta_priv.tipo', '{"es": "Tipo", "en": "Tipo"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Categoría funcional de tipo en el dominio d14. La selección determina las reglas de validación, las políticas aplicables y el comportamiento del motor.', true, 2900),
  ('d14.jit.decision', '{"es": "Decisión", "en": "Decision"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Decisión o acción en el flujo de jit del dominio el dominio d14. Define el desenlace del proceso y las acciones de seguimiento que se activan.', true, 2910),
  ('d14.nhi_secreto.politica_rotacion', '{"es": "Política de rotación", "en": "Rotation Policy"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Política de rotación en el dominio d14. Controla la columna pam_nhi_secret_ref.rotation_policy y asegura integridad referencial sin FK nativa.', true, 2920),
  ('d14.sesion_priv.estado', '{"es": "Estado", "en": "Status"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Estado operativo de estado en el dominio d14. Governa el ciclo de vida del registro y qué transiciones son permitidas según las reglas de negocio.', true, 2930),
  ('d14.grabacion.storage.type', '{"es": "Tipo de almacenamiento", "en": "Storage Type"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Tipo de almacenamiento en el dominio d14. Controla la columna pam_session_recording.storage_type y asegura integridad referencial sin FK nativa.', true, 2940),
  ('priv.aseguramiento.resultado', '{"es": "Resultado", "en": "Outcome"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Resultado de la operación de aseguramiento en privilegios y autorización. Registra si la operación fue exitosa o el tipo específico de fallo para forensia y métricas.', true, 2950),
  ('priv.atom.operacion', '{"es": "Operación", "en": "Operation"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Operación en privilegios y autorización. Controla la columna privilege_atom_audit.operation, privilege_atom_audit_2026_07.operation y asegura integridad referencial sin FK nativa.', true, 2960),
  ('priv.delegacion.estado', '{"es": "Estado", "en": "Status"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Estado operativo de estado en privilegios y autorización. Governa el ciclo de vida del registro y qué transiciones son permitidas según las reglas de negocio.', true, 2970),
  ('priv.excepcion_reg.tipo_excepcion', '{"es": "Tipo de excepción", "en": "Exception Type"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Tipo de excepción en privilegios y autorización. Controla la columna privilege_exception_record.exception_type y asegura integridad referencial sin FK nativa.', true, 2980),
  ('priv.anulacion.tipo_anulacion', '{"es": "Tipo de anulación", "en": "Override Type"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Tipo de anulación en privilegios y autorización. Controla la columna privilege_override.override_type y asegura integridad referencial sin FK nativa.', true, 2990),
  ('priv.recurso.ruta_eval', '{"es": "Ruta de evaluación", "en": "Evaluation Path"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Ruta de evaluación en privilegios y autorización. Controla la columna privilege_resource_atom.evaluation_path y asegura integridad referencial sin FK nativa.', true, 3000),
  ('priv.recurso.estado', '{"es": "Estado", "en": "Status"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Estado operativo de estado en privilegios y autorización. Governa el ciclo de vida del registro y qué transiciones son permitidas según las reglas de negocio.', true, 3010),
  ('priv.recurso.alcance_tenant', '{"es": "Alcance de tenant", "en": "Tenant Scope"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Alcance de alcance de tenant en privilegios y autorización. Define el rango de aplicación de la configuración y qué componentes del sistema aplican el valor.', true, 3020),
  ('priv.recurso.tipo_protocolo', '{"es": "Tipo de protocolo", "en": "Protocol Type"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Proveedor o protocolo de tipo de protocolo en privilegios y autorización. Define el integrador externo y los estándares de interoperabilidad que debe cumplir.', true, 3030),
  ('priv.verbo_conflicto.tipo_conflicto', '{"es": "Tipo de conflicto", "en": "Conflict Type"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Tipo de conflicto en privilegios y autorización. Controla la columna privilege_verb_conflict.conflict_type y asegura integridad referencial sin FK nativa.', true, 3040),
  ('ses.caep.tipo_evento', '{"es": "Tipo de evento", "en": "Event Type"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Tipo de evento en gestión de sesiones. Controla la columna ses_caep_event_log.event_type, ses_risk_policy.trigger_event y asegura integridad referencial sin FK nativa.', true, 3050),
  ('ses.caep.tipo_sujeto', '{"es": "Tipo de sujeto", "en": "Subject Type"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Tipo de sujeto en gestión de sesiones. Controla la columna ses_caep_event_log.subject_type y asegura integridad referencial sin FK nativa.', true, 3060),
  ('ses.sesion.motivo_fin', '{"es": "Motivo de terminación", "en": "Termination Reason"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Motivo de terminación en gestión de sesiones. Controla la columna ses_session_log.termination_reason y asegura integridad referencial sin FK nativa.', true, 3070),
  ('ses.ssf.estado', '{"es": "Estado", "en": "Status"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Estado operativo de estado en gestión de sesiones. Governa el ciclo de vida del registro y qué transiciones son permitidas según las reglas de negocio.', true, 3080),
  ('sig.adsib_ciclo.event', '{"es": "Tipo de evento", "en": "Event"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Tipo de evento en firma digital. Controla la columna sig_adsib_lifecycle.event y asegura integridad referencial sin FK nativa.', true, 3090),
  ('sig.certificado.tipo_adsib', '{"es": "Tipo ADSIB", "en": "Adsib Type"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Tipo ADSIB en firma digital. Controla la columna sig_certificate.adsib_type y asegura integridad referencial sin FK nativa.', true, 3100),
  ('sig.certificado.motor', '{"es": "Motor", "en": "Engine"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Motor en firma digital. Controla la columna sig_certificate.engine y asegura integridad referencial sin FK nativa.', true, 3110),
  ('sig.crl.motor', '{"es": "Motor", "en": "Engine"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Motor en firma digital. Controla la columna sig_crl.engine, sig_key.engine y asegura integridad referencial sin FK nativa.', true, 3120),
  ('sig.doc_politica.engine.required', '{"es": "Motor de firma requerido", "en": "Engine Required"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Motor de firma requerido en firma digital. Controla la columna sig_document_policy.engine_required y asegura integridad referencial sin FK nativa.', true, 3130),
  ('sig.doc_politica.external.profile', '{"es": "Perfil de firma externo", "en": "External Profile"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Perfil de firma externo en firma digital. Controla la columna sig_document_policy.external_profile y asegura integridad referencial sin FK nativa.', true, 3140),
  ('sig.doc_politica.internal.profile', '{"es": "Perfil de firma interno", "en": "Internal Profile"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Perfil de firma interno en firma digital. Controla la columna sig_document_policy.internal_profile y asegura integridad referencial sin FK nativa.', true, 3150),
  ('sig.llave.purpose', '{"es": "Propósito de la llave", "en": "Purpose"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Propósito de la llave en firma digital. Controla la columna sig_key.purpose y asegura integridad referencial sin FK nativa.', true, 3160),
  ('sig.llave.estado', '{"es": "Estado", "en": "Status"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Estado operativo de estado en firma digital. Governa el ciclo de vida del registro y qué transiciones son permitidas según las reglas de negocio.', true, 3170),
  ('sig.operacion.resultado', '{"es": "Resultado", "en": "Outcome"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Resultado de la operación de operacion en firma digital. Registra si la operación fue exitosa o el tipo específico de fallo para forensia y métricas.', true, 3180),
  ('sig.operacion.tipo_firmante', '{"es": "Tipo de firmante", "en": "Signer Type"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Tipo de firmante en firma digital. Controla la columna sig_operation_log.signer_type y asegura integridad referencial sin FK nativa.', true, 3190),
  ('vc.wallet.metodo_respaldo', '{"es": "Método de respaldo", "en": "Backup Method"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Método de respaldo en el dominio vc. Controla la columna wallet.backup_method y asegura integridad referencial sin FK nativa.', true, 3200),
  ('vc.wallet.estado', '{"es": "Estado", "en": "Status"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Estado operativo de estado en el dominio vc. Governa el ciclo de vida del registro y qué transiciones son permitidas según las reglas de negocio.', true, 3210),
  ('vc.emision.resultado', '{"es": "Resultado", "en": "Outcome"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Resultado de la operación de emision en el dominio vc. Registra si la operación fue exitosa o el tipo específico de fallo para forensia y métricas.', true, 3220),
  ('vc.emision.protocolo', '{"es": "Protocolo", "en": "Protocol"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Método o protocolo usado en emision de el dominio vc. Determina los estándares técnicos aplicables y las políticas de seguridad correspondientes.', true, 3230),
  ('vc.item.estado', '{"es": "Estado", "en": "Status"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Estado operativo de estado en el dominio vc. Governa el ciclo de vida del registro y qué transiciones son permitidas según las reglas de negocio.', true, 3240),
  ('vc.item.tipo', '{"es": "Tipo", "en": "Type"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Categoría funcional de tipo en el dominio vc. La selección determina las reglas de validación, las políticas aplicables y el comportamiento del motor.', true, 3250),
  ('vc.presentacion.resultado', '{"es": "Resultado", "en": "Outcome"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Resultado de la operación de presentacion en el dominio vc. Registra si la operación fue exitosa o el tipo específico de fallo para forensia y métricas.', true, 3260),
  ('vc.presentacion.protocolo', '{"es": "Protocolo", "en": "Protocol"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Método o protocolo usado en presentacion de el dominio vc. Determina los estándares técnicos aplicables y las políticas de seguridad correspondientes.', true, 3270),
  ('menu.atom.efecto_requerido', '{"es": "Efecto requerido", "en": "Required Effect"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Efecto requerido en el dominio menu. Controla la columna menu_item_atom.required_effect y asegura integridad referencial sin FK nativa.', true, 3280),
  ('bos.snapshot.alcance', '{"es": "Alcance", "en": "Scope"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Alcance de alcance en el dominio bos. Define el rango de aplicación de la configuración y qué componentes del sistema aplican el valor.', true, 3290),
  ('bos.tenant_politica.modo_politica', '{"es": "Modo de política", "en": "Policy Mode"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Modo de política en el dominio bos. Controla la columna cap_tenant_policy.policy_mode y asegura integridad referencial sin FK nativa.', true, 3300),
  ('bos.audit.operacion', '{"es": "Operación", "en": "Operation"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Operación en el dominio bos. Controla la columna ctx_context_audit.operation y asegura integridad referencial sin FK nativa.', true, 3310),
  ('bos.audit.estado_anterior', '{"es": "Estado anterior", "en": "Old State"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Estado anterior en el dominio bos. Controla la columna ctx_context_audit.old_state, ctx_context_session.state y asegura integridad referencial sin FK nativa.', true, 3320),
  ('bos.emergencia.resultado_revision', '{"es": "Resultado de revisión", "en": "Review Outcome"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Resultado de revisión en el dominio bos. Controla la columna ctx_context_emergency.review_outcome y asegura integridad referencial sin FK nativa.', true, 3330),
  ('bos.emergencia.estado', '{"es": "Estado interno", "en": "State"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Estado operativo de estado interno en el dominio bos. Governa el ciclo de vida del registro y qué transiciones son permitidas según las reglas de negocio.', true, 3340),
  ('bos.transferencia.tipo_transferencia', '{"es": "Tipo de transferencia", "en": "Transfer Type"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Tipo de transferencia en el dominio bos. Controla la columna ctx_context_transfer.transfer_type y asegura integridad referencial sin FK nativa.', true, 3350),
  ('bos.ficha_evento.resultado', '{"es": "Resultado", "en": "Result"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Resultado de la operación de ficha evento en el dominio bos. Registra si la operación fue exitosa o el tipo específico de fallo para forensia y métricas.', true, 3360),
  ('bos.ficha_estado.backend', '{"es": "Backend de ejecución", "en": "Backend"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Backend de ejecución en el dominio bos. Controla la columna fch_ficha_state.backend y asegura integridad referencial sin FK nativa.', true, 3370),
  ('bos.ficha_estado.estado', '{"es": "Estado interno", "en": "State"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Estado operativo de estado interno en el dominio bos. Governa el ciclo de vida del registro y qué transiciones son permitidas según las reglas de negocio.', true, 3380),
  ('bos.bootstrap.estado', '{"es": "Estado interno", "en": "State"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Estado operativo de estado interno en el dominio bos. Governa el ciclo de vida del registro y qué transiciones son permitidas según las reglas de negocio.', true, 3390),
  ('bos.saga.estado', '{"es": "Estado interno", "en": "State"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Estado operativo de estado interno en el dominio bos. Governa el ciclo de vida del registro y qué transiciones son permitidas según las reglas de negocio.', true, 3400),
  ('bos.saga.tipo_saga', '{"es": "Tipo de saga", "en": "Saga Type"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Tipo de saga en el dominio bos. Controla la columna ins_saga_execution.saga_type y asegura integridad referencial sin FK nativa.', true, 3410),
  ('bos.inventario_cert.tipo_cert', '{"es": "Tipo de certificado", "en": "Cert Type"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Tipo de certificado en el dominio bos. Controla la columna net_cert_inventory.cert_type y asegura integridad referencial sin FK nativa.', true, 3420),
  ('bos.inventario_cert.motor_emisor', '{"es": "Motor emisor de certificado", "en": "Issuer Engine"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Motor emisor de certificado en el dominio bos. Controla la columna net_cert_inventory.issuer_engine y asegura integridad referencial sin FK nativa.', true, 3430),
  ('bos.inventario_cert.algoritmo_llave', '{"es": "Algoritmo de llave", "en": "Key Algorithm"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Algoritmo de llave en el dominio bos. Controla la columna net_cert_inventory.key_algorithm y asegura integridad referencial sin FK nativa.', true, 3440),
  ('bos.inventario_cert.estado', '{"es": "Estado", "en": "Status"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Estado operativo de estado en el dominio bos. Governa el ciclo de vida del registro y qué transiciones son permitidas según las reglas de negocio.', true, 3450),
  ('bos.evento_seg.severidad', '{"es": "Severidad", "en": "Severity"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Severidad en el dominio bos. Controla la columna net_security_events.severity, net_security_events_default.severity y asegura integridad referencial sin FK nativa.', true, 3460),
  ('bos.evento_seg.fuente', '{"es": "Fuente", "en": "Source"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Fuente en el dominio bos. Controla la columna net_security_events.source, net_security_events_default.source y asegura integridad referencial sin FK nativa.', true, 3470),
  ('bos.evento_seg.tipo_evento', '{"es": "Tipo de evento", "en": "Event Type"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Tipo de evento en el dominio bos. Controla la columna net_security_events.event_type, net_security_events_default.event_type y asegura integridad referencial sin FK nativa.', true, 3480),
  ('bos.puerto.tipo_activo', '{"es": "Tipo de activo de red", "en": "Asset Type"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Tipo de activo de red en el dominio bos. Controla la columna prt_port_assignment.asset_type y asegura integridad referencial sin FK nativa.', true, 3490),
  ('bos.puerto.tipo_puerto', '{"es": "Tipo de puerto", "en": "Port Type"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Tipo de puerto en el dominio bos. Controla la columna prt_port_assignment.port_type y asegura integridad referencial sin FK nativa.', true, 3500),
  ('bos.puerto.estado', '{"es": "Estado", "en": "Status"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Estado operativo de estado en el dominio bos. Governa el ciclo de vida del registro y qué transiciones son permitidas según las reglas de negocio.', true, 3510),
  ('bos.puerto.transporte', '{"es": "Protocolo de transporte", "en": "Transport"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Protocolo de transporte en el dominio bos. Controla la columna prt_port_assignment.transport y asegura integridad referencial sin FK nativa.', true, 3520),
  ('bos.release.channel', '{"es": "Canal de liberación", "en": "Channel"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Canal de liberación en el dominio bos. Controla la columna rel_release_event.channel, rel_release_manifest.channel y asegura integridad referencial sin FK nativa.', true, 3530),
  ('bos.release.operacion', '{"es": "Operación", "en": "Operation"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Operación en el dominio bos. Controla la columna rel_release_event.operation y asegura integridad referencial sin FK nativa.', true, 3540),
  ('bos.release.resultado', '{"es": "Resultado", "en": "Result"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Resultado de la operación de release en el dominio bos. Registra si la operación fue exitosa o el tipo específico de fallo para forensia y métricas.', true, 3550),
  ('bos.release.disparado_por', '{"es": "Disparado por", "en": "Triggered By"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Disparado por en el dominio bos. Controla la columna rel_release_event.triggered_by y asegura integridad referencial sin FK nativa.', true, 3560),
  ('bos.watchdog.accion_tomada', '{"es": "Acción tomada", "en": "Action Taken"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Acción tomada en el dominio bos. Controla la columna wdg_watchdog_event.action_taken y asegura integridad referencial sin FK nativa.', true, 3570),
  ('bos.watchdog.capa_verificacion', '{"es": "Capa de verificación (watchdog)", "en": "Check Layer"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Capa de verificación (watchdog) en el dominio bos. Controla la columna wdg_watchdog_event.check_layer y asegura integridad referencial sin FK nativa.', true, 3580),
  ('bos.watchdog.tipo_recurso', '{"es": "Tipo de recurso", "en": "Resource Type"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Tipo de recurso en el dominio bos. Controla la columna wdg_watchdog_event.resource_type y asegura integridad referencial sin FK nativa.', true, 3590),
  ('bos.watchdog.resultado_accion', '{"es": "Resultado de la acción", "en": "Action Result"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Resultado de la acción en el dominio bos. Controla la columna wdg_watchdog_event.action_result y asegura integridad referencial sin FK nativa.', true, 3600),
  ('bos.watchdog.severidad', '{"es": "Severidad", "en": "Severity"}'::jsonb, 'CONTEXTUAL'::menu_type_enum,
   'Conjunto de valores válidos para Severidad en el dominio bos. Controla la columna wdg_watchdog_event.severity y asegura integridad referencial sin FK nativa.', true, 3610);
