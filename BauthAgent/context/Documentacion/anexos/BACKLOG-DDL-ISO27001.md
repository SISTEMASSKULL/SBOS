...
| ~~D-18~~ | ~~A.8.10 (EP 1/3)~~ | **→ T-BACKLOG-003 CONFIRMADO** | Gap real. T-154 cubre SOLO historial de versiones de roles (T-152) — no es política general. `idn_identity_attribute` (T-157) y `ses_session_log` no tienen mecanismo de purga. Solución: `cfg_retention_policy` + pg_cron/reconcile. EP→C(3/3). Ver §4.2.2 |
