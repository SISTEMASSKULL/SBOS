...
**Versión:** 3.3.0 · **Fecha:** 2026-08-01 · **Estado: COBERTURA TOTAL** — 38 manuales con anexo(s); 67 anexos. A.65.03 v1.4.0 — 128 bloques canónicos (18 dominios), 14 nuevos de segunda pasada normativa 2025, 4 gaps→P0, correcciones de peso normativo. A.65.03 Investigación Normativa de Bloques Canónicos por Dominio (18 dominios D00–D15/D98/D99, 35+ gaps, átomos `dNN.bloque.verbo`, novedades 2025–2026: SP 800-63-4 final, NIST SP 800-53 R5.2, CAEP 1.0 final, OSDP v2.2.2, DS 5519 AGETIC, SPIFFE/SPIRE, W3C DID CR). A.65.02.03 Modelo de Direccionamiento de Átomos (dirección canónica `dominio.bloque.setpolitica?.politica?.regla?.atomo` + verbo). A.68 v3.0 alineación SBOS-0XX (F.6 no-conformidad XACML 291 átomos, Sección J checklist, Sección K índice por dominio). GAPS-DDL-PRIVILEGIOS-II.md publicado (G-13..G-26 · 14 brechas IAM Enterprise · 17 tablas propuestas T-177..T-193).
...
|---|---|---|:---:|
| [A.01 — El Contrato RolTemplate v6.0](A.01_ANEXO-ROLTEMPLATE-v1.0.md) | FUENTE AUTOSUFICIENTE: 14 bloques + D00 átomos identidad + idn_identity_attribute roles (§22) | 1.09 · 1.04 · 2.05 · 1.06 v2.0 · 2.15 | ✅ 2.2.0 |
| [A.02 — El Contrato UserTemplate v6.0](A.02_ANEXO-USERTEMPLATE-v1.0.md) | FUENTE AUTOSUFICIENTE: idn_identity_entity + idn_identity_attribute + D94 + gobernanza D00 (§23) | 1.08 · 2.01 · 1.06 v2.0 · 1.07 v2.0 · 2.15 | ✅ 1.2.0 |
...
| ✅ A.31 | D+B | **`idn_identity_attribute` = 0 menciones en DDL: la tabla NO existe** (confirma brecha Directory); AT1 DDL P1 — **PUBLICADO** | 1.07 |
...
| ✅ [A.65.02 — Nueva DDL: Inventario limpio v1.0](A.65.02_ANEXO-NUEVA-DDL-v1.0.md) | A | **Inventario de partida para la nueva DDL completa**: 16 secciones IAM Enterprise. Secciones fijas (41 tablas): GLOBAL 8, TENANT 8, ROLES 6, VERSIONADO 4, IDENTIDAD 6, CALENDARIO 9. Secciones nuevas (tablas por definir): USUARIOS · AUTENTICACIÓN · SESIÓN · PRIVILEGIOS (4 tablas T-170–T-173 definidas) · AUDITORÍA · FIRMA DIGITAL · FEDERACIÓN/OIDC · RIESGO/ITDR · PAM · DISPOSITIVOS — **PUBLICADO** | 1.05 · 1.13 · A.65 · A.61 · A.56 · 2.07 |
| ✅ [A.65.02.01 — Operación de Tablas: Decisiones de Diseño DDL v1.2](A.65.02.01_ANEXO-OPERACION-TABLAS-DECISIONES-v1.0.md) | C | **Corrección arquitectónica v1.2:** atom_position pasa a idn_roles_template vía SEQUENCE roles_atom_position_sequential (race condition imposible). DDL completo CREATE TABLE: T-162 con atom_position + CHECK invariante, T-170 FK compuesta + tenant_id + JIT, privilege_atom_audit WORM + trigger pg_advisory_xact_lock, WAL bauth-reactor Redis+CAEP. **12 decisiones de diseño:** motor BitMask Dual (AtomBitMask label vs RolBitMask one-hot), UUIDv7 permanente, 3 categorías de átomos, flujo Kong PEP, XACML 3.0; Zona de Negocios (NGAC/SABSA/ISO 27001); aplicaciones sin tablas; separación dominios; B7 eliminado — **PUBLICADO v1.2** | A.65.02 §PRIVILEGIOS · 1.04 · A.17 · A.67 |
| ✅ [A.65.02.02 — AtomLang: Extensión User Subject (USER/USERSET/userunset) v1.0](A.65.02.02_ATOMLANG-EXTENSION-USER-SUBJECT.md) | C | **Especificación de extensión del compilador AtomLang** para soportar overrides a nivel de usuario diferenciados de rol: nuevos kinds `USER { user_id }` y `USERSET { user_set_id }` en `Subject`; campo `userunset` en `Target`; jerarquía de precedencia `userunset > unset > USER > USERSET > SET > ROL > ANY`; algoritmo de normalización en dos pasos (strip effect → agrupar por clave normalizada → resolver por Subject kind); 5 nuevos códigos de error `ATOMC-E-063/064/065/CON-001/W-033`; 4 archivos Rust a modificar con código exacto. Surge del cierre de G-02. **PENDIENTE DE IMPLEMENTACIÓN** | A.65.02.01 · A.46 · A.47 |
| ✅ [A.65.02.03 — AtomLang: Modelo de Direccionamiento de Átomos v1.0](A.65.02.03_ATOMLANG-MODELO-DIRECCIONAMIENTO-ATOMO-v1.0.md) | C | **Modelo canónico de direccionamiento jerárquico:** formato `{dominio}.{bloque}.{setpolitica?}.{politica?}.{regla?}.{atomo}.{verbo}` — 4 a 7 segmentos; `.` separa niveles, `_` une palabras dentro de un segmento; charset `[a-z0-9_]`; 3 segmentos obligatorios (dominio, bloque, átomo) + verbo siempre último; tabla de 15 dominios D00–D13/D99; vocabulario canónico de 15 verbos; mapeo a columna `clave` T-162 (RuleId XACML) con dirección acumulada por nivel; responsabilidad de `atomc` para generar slugs sin cambiar el árbol Dart fuente; bloques canónicos por dominio **pendientes HITL** — **PUBLICADO** | A.65.02.02 · A.65.02.01 · A.68 §F.6 · A.46 · A.47 |
| 🆕 [A.65.02.04 — Propuesta DDL Secciones Pendientes v2.1.0](A.65.02.04_PROPUESTA-SECCIONES-PENDIENTES-v1.0.md) | B | **Propuesta DDL (HITL pendiente):** 38 tablas en 6 secciones — S13 USUARIOS (T-320..322: idn_user/history/recovery · WORM); S14 AUTENTICACIÓN (T-330..341: auth_credential · fido2 · x509 · attempt_log WORM · catálogos); S15 FIRMA DIGITAL (T-350..357: sig_key · sig_certificate · sig_crl · sig_operation_log WORM · sig_document_hash WORM · sig_timestamp RFC 3161 · sig_adsib_lifecycle WORM · **sig_document_policy** política de motores Ley 164 Art. 82); BLOCKCHAIN D12 (T-358..362: blk_anchor · blk_merkle_batch · blk_merkle_leaf · blk_account · blk_reconciliation — naming canónico); S16 FEDERACIÓN/OIDC parcial (T-365..367: fed_client · fed_provider_ext · fed_token_issued WORM); S17 BILLETERA DIGITAL (T-380..383: wallet · wallet_item · wallet_presentation_log WORM · wallet_issuance_log WORM). Naming: inglés para identificadores SQL, español para documentación. — **PROPUESTA** | A.65.02 · A.65.02.05 · A.65.02.01 |
| 🆕 [A.65.02.05 — Propuesta DDL OIDC Completo v1.0.0](A.65.02.05_PROPUESTA-OIDC-COMPLETO.md) | B | **Propuesta DDL OIDC completo (HITL pendiente):** 7 tablas — T-368 fed_device_code (RFC 8628 Device Auth Grant con anti slow-down); T-369 fed_jwks_key (RFC 7517 JWKs por tenant, privada en Vault); T-370 fed_par_request (RFC 9126 Pushed Authorization Request, previene manipulación de parámetros); T-371 fed_discovery_cfg (OIDC Discovery 1.0, fuente del .well-known por tenant); T-372 fed_logout_session (OIDC Back-Channel Logout + CAEP, coordinación multi-cliente); T-373 fed_token_exchange_log (RFC 8693 WORM: delegación · impersonación · scope_narrowing · federación); T-374 fed_consent (OIDC Core §3.1.2.1 + GDPR Art. 7, consentimiento revocable). — **PROPUESTA** | A.65.02.04 · A.65.02 · A.65.02.01 |
| ✅ [A.65.03 — Investigación Normativa: Bloques Canónicos por Dominio v1.4.0](A.65.03_INVESTIGACION-BLOQUES-CANONICOS-DOMINIOS-v1.0.md) | B+C | **Investigación normativa completa de los 18 dominios (D00–D15, D98, D99)**: **128 bloques canónicos** (segunda pasada vs normas 2024–2026). D00: cuatro cuadrantes General/Particular × Rol/Usuario. 14 bloques nuevos añadidos (VC 2.0, FAL, dynamic_policy, mustering, open_banking, propagation, ITDR, introspection, rich_authorization, EUDI Wallet, session_recording, attestation, governance NHI, supply_chain). 4 gaps→P0 (passkey, quality biométrica, identity_proofing DDL, fraud PCI DSS). Correcciones normativas: IAD→ISO 30107-3:2023 formal; VCDM 2.0 Recommendation vs DID CR; ADSIB→AGETIC HITL. Fuentes 2024–2026: CAEP 1.0 Final sep 2025, SP 800-63-4 jul 2025, 800-53 R5.2 ago 2025, W3C VCDM 2.0 may 2025, ISO 29794-1:2024, eIDAS 2.0, CIS v8.1, Gartner PAM/NHI 2025, CSA NHI, SPIFFE/SPIRE. — **PUBLICADO** | A.65.02.03 · A.47 · A.05 · 1.01 |
...
| ✅ [A.68 — Catálogo de Propiedades de Átomos v2.0](A.68_CATALOGO-PROPIEDADES-ATOMOS-v1.0.md) | C | **Inventario completo + correcciones + alineación normativa**: Tipos A-E (propiedades XACML: verbo 15, combining_algorithm 4, op_lógico 2, 150 props, 16 ops, 57 obligation keys, 176 _a, 45 _en). **Sección F**: 13 claves con `·`/`*`/`/`/espacios (F1), 9 valores mixtos número+texto (F2), 1 error semántico IS_SET (F3.a), **error CRÍTICO password max 64 viola NIST 800-63B-4 §5.1.1.1** (F3.b), case-sensitivity verbos (F3.c), 9 placeholders `'null'→NONE/INHERIT` (F3.d). **Sección H**: alineación verificada vs XACML 3.0 / NIST 800-63B-4 / NIST 800-207 / ISO 27001:2022 / FIDO2 / OAuth2-CAEP / PCI DSS 4.0 (gap `rpId` WebAuthn, `aggregate-strictest` custom). **Sección I**: nueva observación `TipoNodo.normativo` + `_norm()` helper + 14 IDs canónicos de estándar + impacto T-162 — citación explícita y auditable de normas en el árbol — **PUBLICADO v2.0** | `rol_template_datos.dart` · A.65.02.01 · GAPS-DDL-PRIVILEGIOS.md |
| ✅ [A.69 — Revisión DDL V2: Bugs e Inconsistencias v1.2](A.69_ANEXO-REVISION-DDL-V2-BUGS-v1.0.md) | C | **Hallazgos de revisión del DDL V2 completo** (3.360 líneas): inconsistencias de tipos, constraints faltantes, columnas sin índice, naming no canónico — **PUBLICADO v1.2** | `DDLs/SBOS_db_V2_DDL.sql` · A.65.02.01 · A.65.01 |
| ✅ [A.70 — Recursos Kubernetes: B02 Reconcile + NetworkPolicies v1.0](A.70_ANEXO-BAUTH-KUBERNETES-RESOURCES-v1.0.md) | C | **Manifests idempotentes** para reconstrucción sin fricción: B02 reconcile loop de expiración de roles · NetworkPolicies deny-all · recursos K8s bAuth verificados en VPS — **PUBLICADO v1.0** | 3.01 reconcile loop · A.13 K8s |
| ✅ [A.71 — Informe de Cumplimiento ISO 27001:2022 — DDL bAuth v1.6](A.71_INFORME-CUMPLIMIENTO-ISO27001-2022-v1.0.md) | B+C+D | **Score 99/123 (80 %) — 41 controles en-scope — 23/41 cubiertos.** 15 discrepancias D-01..D-15 analizadas. 7 falsos positivos cerrados (A.8.3, A.8.11, A.5.14, A.8.9, A.8.17 y otros). 9 gaps reales → BACKLOG-DDL-ISO27001.md. Scorecard por sección: A.5 81.5 % · A.6 33.3 % · A.8 78.8 % — **PUBLICADO v1.6** | `DDLs/SBOS_db_V2_DDL.sql` · A.72 · BACKLOG-DDL-ISO27001 · 5.01 · 2.09 |
| ✅ [A.72 — Ciclo de Vida de Desarrollo Seguro (SDL) — bAuth v1.0](A.72_ANEXO-SDL-CICLO-VIDA-SEGURO-v1.0.md) | B+C+D | **Respaldo ISO 27001:2022 A.8.25 + NIST SP 800-218 SSDF + OWASP SAMM v2.0.** Importa y consolida TODO el conocimiento SDL: 8 ADRs completos (ADR-001→010+D12), STRIDE×NRS cableado (6 amenazas), 12 reglas SAN, 10 reglas NRS, Revisor ORQUESTA + AA-1, suite tests Rust, despliegue systemd. Score A.8.25: P(2/3) — 5/7 requisitos cubiertos. Gap P2: CI SAST/DAST/cargo-audit sin automatizar — **PUBLICADO v1.0** | 2.09 §3-7-11 · A.71 §4.6 |

#### Documentos de tracking activo — no son A.XX canónicos

| Documento | Contenido | Estado |
|---|---|:---:|
| [GAPS-DDL-PRIVILEGIOS.md](GAPS-DDL-PRIVILEGIOS.md) | G-01..G-12 — modelo 5 columnas T-170, flujo evaluación, índices, SoD. Referenciado desde A.68, A.65.02.01, A.65.02. | 🔄 ACTIVO |
| [GAPS-DDL-PRIVILEGIOS-II.md](GAPS-DDL-PRIVILEGIOS-II.md) | **G-13..G-26 — 14 brechas IAM Enterprise (IGA·AM·PAM·NHI·CAEP).** 17 tablas propuestas T-177..T-193. Prioridades: 🔴 G-13/G-17/G-20/G-21 · 🟠 G-14..G-16/G-18..G-19/G-22..G-23/G-25 · 🟡 G-15/G-24/G-26. Orden de resolución en §tabla-final. | ⚠️ ABIERTO |
...
| 1.07 Atributos | **A.31** ✅ (idn_identity_attribute sin DDL) | ✅ |
...
| 2.09 Seguridad | A.11 · **A.72** ✅ (SDL — STRIDE, NRS, SAN, ADRs, Revisor, gap P2 CI) | ✅ |
...
| 2.15 Motor de Identidad | **A.31** ✅ (idn_identity_attribute) · **A.02** ✅ (UserTemplate) · **A.01** ✅ (RolTemplate) | ✅ |
...
|---------|-------|-------------|
| 3.3.0 | 2026-08-01 | **72 anexos totales.** +4 registros: A.69 Revisión DDL V2 Bugs v1.2, A.70 Recursos Kubernetes B02 v1.0, A.71 Informe Cumplimiento ISO 27001:2022 v1.6 (99/123 · 80%), A.72 SDL Ciclo de Vida Seguro v1.0 (ISO A.8.25 P 2/3 · ADRs+STRIDE+NRS+SAN importados). 2.09 Seguridad actualizado: A.11 + A.72. |
| 3.1.0 | 2026-07-23 | **67 anexos totales.** A.65.03 Investigación Normativa de Bloques Canónicos por Dominio v1.0: investigación completa de los 18 dominios (D00–D15, D98, D99) contra normas primarias verificadas (ISO 24760-2:2025, NIST SP 800-63-4 final ago 2025, NIST SP 800-53 R5.2 ago 2025, OpenID CAEP 1.0 final 2025, IEC 60839-11-5:2020, SIA OSDP v2.2.2 oct 2024, PCI DSS 4.0.1, ISO/IEC 30107-3:2023, NIST SP 800-207 + 207A, INCITS 359-2012 R2022, ISO 27001:2022, RFC 3161, ETSI EN 319 422, SPIFFE/SPIRE CNCF, DS 5519/AGETIC ene 2026, W3C DID Core v1.1 CR mar 2026). 35+ gaps identificados con prioridad. Árbol de átomos canónicos `dNN.bloque.verbo` por dominio. Matriz de completitud (0 ✅ / 9 🟡 / 5 🔴 / 2 ❌). Aclaraciones de peso normativo (IR vs SP vs CR). Decisiones HITL pendientes (AGETIC, subject_type, NHI grant). |
...
| 3.0.0 | 2026-07-21 | **GAPS-DDL-PRIVILEGIOS-II.md publicado.** G-13..G-26: 14 brechas IAM Enterprise contra 4 pilares (IGA·AM·PAM·NHI) + CAEP. 17 tablas propuestas T-177..T-193 (campañas certificación, excepciones, política riesgo adaptativo, sesión persistente, JIT, credenciales privilegiadas, grabación sesión, break-glass, NHI, secretos NHI, agentes IA, CAEP log, SSF config). Orden de resolución en 3 fases. Registro en INDICE como documento de tracking activo. |
| 2.9.0 | 2026-07-20 | **A.68 v2.0**: secciones F–I ampliadas. F: 22 correcciones exactas por línea (claves inválidas, valores mixtos, IS_SET sin valor, error crítico password max 64 viola NIST 800-63B-4 §5.1.1.1, case-sensitivity verbos, 9 placeholders null). H: alineación verificada vs 8 estándares (gaps: rpId WebAuthn, aggregate-strictest custom no documentado). I: nueva observación TipoNodo.normativo — 14 IDs canónicos de estándar, helper `_norm()`, impacto T-162. |
| 2.8.0 | 2026-07-20 | **65 anexos totales.** A.68 Catálogo de Propiedades de Átomos: inventario completo de los 5 tipos de propiedad del árbol RolTemplate (A estructura XACML, B condición evaluación, C efecto+obligaciones, D metadatos, E enumerados). 150 props únicas, 16 operadores, 57 obligation keys, 176 atributos _a, 45 enumerados _en. 7 hallazgos de reparación F1-F3 con correcciones. Mapa propiedad→columna T-162. |
| 2.7.0 | 2026-07-20 | **64 anexos totales.** A.65.02.01 Decisiones DDL sección PRIVILEGIOS: doctrina completa del motor BitMask Dual (AtomBitMask label vs RolBitMask one-hot), atom_position inmutable en privilege_atom_grant (no en T-162), UUIDv7 garantiza posición de bit permanente, 3 categorías de átomos (generales/set/UNSET), flujo Kong PEP, XACML 3.0. Sección PRIVILEGIOS en A.65.02 actualizada con T-170–T-173. |
...
| 1.4.0 | 2026-07-11 | **COBERTURA TOTAL COMPLETADA: los 36 manuales con anexo(s), 40 anexos publicados.** Segunda ola de sustentación cerrada (A.15–A.40) con verificación de código real. **Hallazgos crudos de reparación:** 🔴 seguridad P1 — pipeline FAIL-OPEN (A.21), DPoP stub que retorna verified:true sin criptografía (A.28), RLS ausente 0 policies (A.22); ⚠️ código sin cablear — Risk Engine `#![allow(dead_code)]` (A.26), emisor de auditoría esqueleto (A.27), Redis desactivado H-019 (A.15/A.17/A.40); ❌ ausentes — `idn_identity_attribute` sin DDL (A.31), SAM-128 sin calcular (A.17), compliance sin población (A.25); 🟠 divergencias — frontend 3 stacks (A.18); ✅ corrección — colisión token.validate era falso positivo (A.19). Motor de Versionado L1 (A.33). A.17 reescrito por el humano (identifica shims) conservado. |
