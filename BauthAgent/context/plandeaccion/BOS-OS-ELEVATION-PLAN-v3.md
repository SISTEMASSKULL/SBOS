...
bosctl top
┌──────────────────────────────────────────────────────────────────────┐
│  BOS TOP — sbos-greenfield — 2026-05-19 14:00:00 UTC                │
│                                                                      │
│  NODO (fuente: Ubuntu /proc + kubectl top nodes)                    │
│  sbos-greenfield   CPU 12%   MEM 34%   DISK 28%   STATUS: Ready    │
│                                                                      │
...
```
BOS BUSINESS OS — CATÁLOGO DE APLICACIONES — sbos-greenfield
═══════════════════════════════════════════════════════════════
...
```
BOS SECURITY SCAN — sbos-greenfield
══════════════════════════════════════════════════════
UBUNTU HARDENING
