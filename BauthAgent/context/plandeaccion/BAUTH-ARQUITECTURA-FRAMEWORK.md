...
>
> ✅ **IDENTIDAD CONFIRMADA — JUNIO 2026:** Este documento describe correctamente a bAuth como el **Identity Control Plane** (orquestador central) siguiendo el patrón Helidon/Duende IdentityServer/Apache Doris. bAuth NO autentica — enruta credenciales a los motores (KC, Vault, Besu), recibe resultados, aplica sus propias reglas (BitMask + DomainRegistry + SoD + DAG), y emite el JWT final con todos los claims. Ver MANUAL_DB_DDL.md §41 para el flujo end-to-end completo.
