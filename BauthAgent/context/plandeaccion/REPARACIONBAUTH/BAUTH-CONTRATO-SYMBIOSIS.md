# BAUTH-CONTRATO-SYMBIOSIS — La Unión Bilateral
## Principio de Simbiosis: bAuth ↔ Keycloak
### v2.0 · 2026-06-28 · SKULL · Arquitectura Bilateral (Tryton deprecado)

---

> ⚠️ **ACTUALIZACIÓN JUNIO 2026:** Tryton fue deprecado como motor de autorización por **ADR-010**. Las 5 capas de enforcement de Tryton ahora las resuelve bAuth nativamente (62 rule types + PolicyEngine XACML 3.0 + 12 dominios). La simbiosis pasó de **trilateral** (bAuth↔KC↔Tryton) a **bilateral** (bAuth↔Keycloak). Keycloak sigue siendo el motor de identidad. La autorización es 100% bAuth. Ver `adrs/ADR-010-DEPRECACION-TRYTON.md`.

## 1. Metáfora: La Red Neuronal Simbiótica

> **Así como las neuronas se unen por afinidad química, formando redes que persisten
> aunque algunas mueran y renazcan, bAuth y Keycloak se unen simbióticamente
