...
**Versión:** 1.1 · **Fecha:** 2026-06-28 · **Estado:** VIGENTE · Tryton deprecado (ADR-010)

> ⚠️ **ACTUALIZACIÓN JUNIO 2026:** Tryton fue deprecado como motor de autorización. Las 5 capas de enforcement ahora las resuelve bAuth nativamente (62 rule types + PolicyEngine XACML 3.0). La simbiosis pasó de trilateral a **bilateral bAuth↔Keycloak**. B13 completo deprecado. B10-B11 simplificados (sync solo a KC). Ver `adrs/ADR-010-DEPRECACION-TRYTON.md`.
...
> ⚠️ **CORRECCIÓN BITMASK — JUNIO 2026:** El modelo actual es el **BitMask Dual**: BitMask Átomo 64-bit (label encoding) + Rol BitMask N-bit (one-hot encoding).
