...
\ir ../data_files/authentication_framework_data.sql
\ir ../data_files/policies_framework_data.sql

-- Fuentes investigación 2025-2026 (inline SQL)

-- Fuentes investigación 2025-2026 (inline)
\ir ../data_files/insert_nist_rev4.sql
\ir ../data_files/insert_fido2_ctap.sql
\ir ../data_files/insert_nist_pqc.sql
\ir ../data_files/insert_oauth_21.sql
\ir ../data_files/insert_zero_trust.sql
\ir ../data_files/insert_iso_27001.sql
\ir ../data_files/insert_industry.sql
\ir ../data_files/insert_d3_financiero.sql
\ir ../data_files/insert_d4_temporal.sql
\ir ../data_files/insert_d6_geo.sql
\ir ../data_files/insert_d10_delegacion.sql
\ir ../data_files/insert_cis_k8s.sql
\ir ../data_files/insert_aws_iam.sql
\ir ../data_files/insert_soc2.sql
