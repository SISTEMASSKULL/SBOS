...
CREATE TABLE IF NOT EXISTS bauth.bos_tenant (
    -- === IDENTIDAD CENTRAL ===
    tenant_id       TEXT        PRIMARY KEY,              -- ej: 'skull', 'acme', 'inka'
...
CREATE TABLE IF NOT EXISTS bauth.bos_idioma (
    locale           TEXT        PRIMARY KEY,               -- es-BO, en-US, zh-CN, pt-BR, qu-BO
...
CREATE TABLE IF NOT EXISTS bauth.bos_timezone (
    timezone_id      TEXT        PRIMARY KEY,               -- 'America/La_Paz', 'Asia/Shanghai'
...
CREATE TABLE IF NOT EXISTS bauth.bos_tenant_config (
    ...
    locale_default  TEXT        NOT NULL DEFAULT 'es-BO',
    ...
    notification_locale TEXT   NOT NULL DEFAULT 'es-BO',    -- Idioma de notificaciones
...
CREATE TABLE IF NOT EXISTS bauth.bos_sitio_fisico (
    sitio_id        TEXT        PRIMARY KEY,              -- ej: 'SITIO-LAPAZ-CENTRO'
    tenant_id       TEXT        NOT NULL,
...
CREATE TABLE IF NOT EXISTS bauth.bos_rol_template (
    ...
    tenant_id       TEXT        DEFAULT NULL,     -- '*' = global, tenant_id = específico
