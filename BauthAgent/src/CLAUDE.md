...
| **47 métodos auth (12 implementados)** | Universo canónico según `2.02_MANUAL-METODOS-ESTADO-INDUSTRIA-v1.0.md` v1.1.0. Taxonomía NIST: A=Conocimiento · B=Posesión · C=Inherencia · D=Federación · E=Flujos · F=Emergente. **Implementados (✅):** Contraseña+Argon2id, Recovery Codes, TOTP, HOTP, WebAuthn/Passkey, FIDO2 Security Key, Email OTP, Push Challenge Ed25519, mTLS X.509, SAML 2.0, Step-Up RFC 9470, SCIM. **Prohibidos:** SMS OTP (DEPRECATED), Security Questions (REMOVED — NIST 800-63B-4). Resto: PLANNED por prioridad P1-P4 en `2.02`. |
