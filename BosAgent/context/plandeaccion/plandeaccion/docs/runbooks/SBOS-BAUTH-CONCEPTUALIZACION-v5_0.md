...
| **Integra** | SBOS-009 · SBOS-019 · SBOS-020 · SBOS-008-001 · SAM-128 · SBOS-PLAN-ACTUALIZACION-CONSOLIDADO-v3_0 · SBOS-BAUTH-DECISIONES-ARQUITECTURA-v1_0 · SBOS-BAUTH-REQUERIMIENTOS-TECNICOS-v1_2 · SBOS-DOMINIOS-AUTENTICACION-Y-RECONCEPTUALIZACION · SBOS-BITMASK-ANALISIS-SAM128-Y-PLAN-CORREGIDO |
| **Correcciones críticas** | J1–J11 (jurisdicción · contraseñas NIST SP 800-63B-4) · K1–K7 (KC integraciones externas) |
| **Nuevas secciones** | §20 Requerimientos de Infraestructura · §21 Catálogo de 15 Métodos · §22 `deploy.yml` · §23 Correcciones SAM-128 |
