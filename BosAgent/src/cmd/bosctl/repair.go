// Subcomando de reparación: bosctl repair [--target=all|os|k8s|bos] [--dry-run] [--timeout=600].
package main
...
// cmdRepair invoca el RepairManager para reparar capas OS/K8s/BOS. Retorna JSON del resultado.
