// Package packages implementa el gestor de paquetes unificado del SBOS (D2).
//
// Backends: apt (sistema), pip (python), helm (kubernetes).
// Auto-genera una ficha tras cada instalación exitosa.
package packages
...
// NewAptAdapter crea un adaptador apt para gestión de paquetes del sistema.
...
// IsInstalled verifica si un paquete está instalado vía dpkg-query.
