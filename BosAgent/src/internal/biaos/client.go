...
// A-12: system prompt cargado desde archivo embebido (ai/system-prompt.txt).
// Para personalizar sin recompilar, editar el archivo y recompilar.
//
//go:embed ai/system-prompt.txt
