...
### S05 · devserver/ — Desarrollo Propio

Código propio: Laravel, Vue.js, Django SIAT Bolivia, Celery workers. Ciclos de deploy frecuentes, pipeline independiente.

**6 aplicaciones. Criticidad: ALTA.**
...
└── KUBERNETES CLUSTER
    ...
    │   Laravel · Vue.js · Django SIAT Bolivia
    │
