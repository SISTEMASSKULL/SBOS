...
|Componente|Licencia|Evaluación|
|-|-|-|
|SmartTax|MIT (SKULL)|✅ Desarrollo propio SKULL|
|SmartReport|MIT (SKULL)|✅ Desarrollo propio SKULL|
|SmartRates|MIT (SKULL)|✅ Desarrollo propio SKULL|
|SmartORC|MIT (SKULL)|✅ Desarrollo propio SKULL|
|SmartVaultFlow|MIT (SKULL)|✅ Desarrollo propio SKULL|
|SmartPortfolio|MIT (SKULL)|✅ Desarrollo propio SKULL|
|SmartPay|MIT (SKULL)|✅ Desarrollo propio SKULL|
...
|S05|`devserver/`|Proyectos de desarrollo propio SKULL|7|
...
|2|RabbitMQ 3.13+|Message broker AMQP|MPL 2.0|Desacoplamiento asíncrono Tryton ↔ Saleor, Airflow, SmartTax. Persistencia en disco cifrada.|
...
Proyectos de desarrollo propio de SKULL. Cada proyecto es una aplicación independiente desplegada como ficha SBOS con su propio ciclo de vida. Ciclos de deploy frecuentes, pipeline independiente.

|#|Aplicación|Tipo|Licencia y Edición|Función|
|:-:|-|-|-|-|
|1|SmartTax|Tax compliance|MIT (SKULL)|Strategic Tax Compliance & Management. Cumplimiento legal-fiscal BO/AR/MX. Firma XML, envío SIN/AFIP/SAT, contingencia offline.|
|2|SmartReport|BI / Reporting|MIT (SKULL)|Business Intelligence & Advanced Reporting. Analítica de datos y generación de reportes para toma de decisiones.|
|3|SmartRates|Pricing engine|MIT (SKULL)|Dynamic Pricing & Rate Control Systems. Gestión de tarifas y competitividad de mercado.|
|4|SmartORC|Correspondence|MIT (SKULL)|Correspondence Receipt & Operational Response Office. Ciclo completo de recepción, procesamiento y respuesta al cliente.|
|5|SmartVaultFlow|Document vault|MIT (SKULL)|Secure Document Repository & Workflow Logic. Custodia blindada y movimiento inteligente de archivos.|
|6|SmartPortfolio|Catalog generator|MIT (SKULL)|Custom Asset Curation & Catalog Generation. Transformación de PDFs en herramientas comerciales de alto valor.|
|7|SmartPay|Payment gateway|MIT (SKULL)|Integrated QR Resolution & Payment Gateway Logic. Orquestación de pagos digitales y resolución de transacciones vía QR.|
...
|`/api/v1/billing/`|v1|SmartTax / SmartPay|Emisión de facturas, consulta SIN, CUF, pagos QR|
