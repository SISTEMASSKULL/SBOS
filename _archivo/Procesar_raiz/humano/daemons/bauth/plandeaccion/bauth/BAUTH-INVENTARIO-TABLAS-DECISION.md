...
| 4293 | `idn_role_d1` | Nueva | Roles pre-configurados D1: OPERADOR_CAJA, GERENTE_REGIONAL... | ✅ |
...
| 2344 | `ath_policy` | Existente | 5 políticas legacy (datos reales en ath_policy_d*) | ✅ |
| 2309 | `ath_config` | Existente | 4 configuraciones legacy (datos reales en ath_config_d*) | ✅ |
| 3102 | `ath_credential_policy` | Migrada | Ciclo de vida credenciales: fortaleza, rotación, HIBP, bloqueo | 🔴 |
...
| 4256 | `ath_config_d1` a `ath_config_d12` | Nuevas | 12 tablas de configs default por dominio | ✅ |
...
| 3612 | `aud_compliance_map` | Migrada | 34 controles: ISO+NIST+PCI+GDPR | 🔴 |
...
| Línea | Tabla | Origen | Propósito | Seed |
|:---:|-------|--------|----------|:---:|
| 3787 | `idn_user_template` | Migrada | Template usuario SCIM 2.0. Roles, contextos, BitMask, sync | 🔴 |
...
*Documento v7.0 final. 177 tablas con número de línea. Listo para revisión.*
