...
## SKULL · SBOS · Abril 2026 · v1.1 · BitMask Dual Jun 2026
### Arquitecto: Principal Systems Architect

---

> ⚠️ **CORRECCIÓN BITMASK — JUNIO 2026:** Las referencias a SAM-128, "2 capas", "capa 1/capa 2", "7×64 bits" en este documento corresponden al modelo anterior. El modelo actual es el **BitMask Dual** (`SBOS-MANUAL-SISTEMA-PRIVILEGIOS-v1.0.md`): BitMask Átomo 64-bit (label encoding) para identificación + Rol BitMask N-bit (one-hot encoding) para combinación de roles. Para desarrollo, usar los manuales actualizados.
