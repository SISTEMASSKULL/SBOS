...
## 7. Pruebas de Blockchain — Sin pods levantados

### Estrategia de prueba sin infraestructura Besu:

```
┌──────────────────────────────────────────────────────────────┐
│                CAPAS DE PRUEBA (de menor a mayor)             │
│                                                               │
│  CAPA 1: Pruebas unitarias (SIEMPRE disponibles)              │
│  ┌──────────────────────────────────────────────────────┐    │
...
│  └──────────────────────────────────────────────────────┘    │
│                                                               │
│  CAPA 2: Pruebas de integración (BD real en VPS)              │
│  ┌──────────────────────────────────────────────────────┐    │
...
│  └──────────────────────────────────────────────────────┘    │
│                                                               │
│  CAPA 3: Simulación (sin blockchain real)                     │
│  ┌──────────────────────────────────────────────────────┐    │
│  │ AnchorVerify handler: verifica proofs sin on-chain   │    │
│  │ Block Simulator: genera eventos → Merkle → "ancla"   │    │
│  │   en registro local (bos_merkle_batch)                │    │
│  │ bos-verify offline: verifica contra proof local       │    │
│  └──────────────────────────────────────────────────────┘    │
│                                                               │
...
**Actualmente estamos en CAPA 1 + 2 (verificadas en VPS).**  
La CAPA 3 (simulación) se puede construir AHORA sin pods.  
La CAPA 4 (testnet público) necesita ethers-rs compilado.  
La CAPA 5 (red propia) necesita las fichas BOS y K8s.
