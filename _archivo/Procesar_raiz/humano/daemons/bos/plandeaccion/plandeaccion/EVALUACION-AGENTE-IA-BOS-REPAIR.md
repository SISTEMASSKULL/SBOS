...
# ADDENDUM — Evaluación de preparación para las fases F11-F17 · Junio 2026

La evaluación 9.7/10 midió la preparación para ejecutar F0-F10 (hoy 89/89 ✅).
Para las fases F11-F17 el ecosistema documental se amplió:

| Capa | Documentos nuevos | Estado |
|---|---|---|
| Conocimiento técnico | SBOS-BAUTH-* (contrato socket + SAM-128/BitmaskBundle v3) · SBOS-NEXUS v3.0 (protocolo WS :9444) · SBOS-ROLTEMPLATE/USERTEMPLATE v5.0 · MANUAL DE PRIVILEGIOS | ✅ en knowledge |
| Decisiones | BOS-REPAIR-16-ADR007 (stubs) · BOS-REPAIR-CUESTIONARIO-01 (respuestas del operador) | ✅ |
| Plan | PLAN-MAESTRO v4.0 (PARTE V) · REGISTRO-ESTADO con F11-F17 | ✅ |
| Specs de desarrollo | BOS-REPAIR-14-SBOS-CLIENT-SPEC (WS, monorepo, 3 modos, push) · BOS-REPAIR-15-ESTANDARES | ✅ |

**Gaps que el agente debe cubrir leyendo (no preguntar al operador):**
contrato bauth → SBOS-BAUTH-DECISIONES §C1-C3 · protocolo bhnexus →
SBOS-NEXUS §6-8 · permisos → ROLTEMPLATE v5.0 §B9 + BITMASK-SAM128 §2.2 ·
fichas → SBOS-019 + código legacy (_snapshots/) · VDI → SBOS-052.

**Regla aprendida (Cuestionario-01):** ante una duda, el orden es
documentación del knowledge → código legacy/_snapshots → BosAgent/ raíz →
solo entonces escalar. Las preguntas cuya respuesta está en los documentos
no se escalan.

**Preparación para F11-F17: LISTA** — condicionada solo a recuperar acceso
SSH (F10.10/F0.6.S prioritarios) bajo protocolo sbos-staging-security-monitor.
