...
|---|---|---|---|
| 0 | Fundación — estructura de paquetes | 🔴 NO INICIADA | 2 horas |
| 1 | Extraer infraestructura de cmd/bos/main.go | 🔴 NO INICIADA | 2-3 días |
| 2 | Unificar transporte WebSocket | 🔴 NO INICIADA | 1 día |
| 3 | Partir install_ui.go | 🔴 NO INICIADA | 3-4 días |
| 4 | Limpiar cmd/bosctl/ | 🔴 NO INICIADA | 1 día |
| 5 | Context Plane completo (SBOS-049) | 🔴 NO INICIADA | 3-4 días |
| 6 | JSON-RPC robusto | 🔴 NO INICIADA | 1-2 días |
| 7 | Documentación del código (ADR-003) | 🔴 NO INICIADA | continuo |
