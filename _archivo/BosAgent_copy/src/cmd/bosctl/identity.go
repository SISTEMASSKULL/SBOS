...
// cmdIdentity dispatches identity subcommands.
// Fase B — Identity management (FileRBAC-backed, BauthRBAC-ready).
...
// cmdIdentityWhoami prints the current BOS_USER and resolved role.
...
// cmdIdentityUsers lists all users and their roles.
...
// cmdIdentityRoles lists all defined roles and their allowed commands.
...
// cmdIdentitySetRole assigns a role to a user.
// Usage: bosctl identity set-role <user> <role>
...
// cmdIdentityRevoke removes a user from the RBAC config.
// Usage: bosctl identity revoke <user>
...
// getIdentityProvider returns the IdentityProvider, preferring FileRBAC
// since BauthRBAC delegates identity operations to FileRBAC anyway.
