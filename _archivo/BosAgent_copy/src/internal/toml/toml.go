...
// DecodeFile reads a TOML file and decodes it into the given struct pointer.
// Returns nil metadata and any decoding error.
...
// Unmarshal decodes TOML data into the given struct pointer.
