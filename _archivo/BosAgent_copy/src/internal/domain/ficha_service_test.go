...
func TestFichaService_ExecuteSaga(t *testing.T) {
	...
	ins := &mockInstaller{
		installFn: func(id, ver string) (*installer.SagaResult, error) { calls["install"] = true; return okSaga("install", id), nil },
		updateFn:  func(id, ver string) (*installer.SagaResult, error) { calls["update"] = true; return okSaga("update", id), nil },
		repairFn:  func(id string) (*installer.SagaResult, error)       { calls["repair"] = true; return okSaga("repair", id), nil },
		removeFn:  func(id string) (*installer.SagaResult, error)       { calls["remove"] = true; return okSaga("remove", id), nil },
